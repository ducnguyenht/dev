<%@ Control Language="C#" ClientIDMode="AutoID" AutoEventWireup="true" CodeBehind="ucDeliverySchedule.ascx.cs"
    Inherits="WebModule.Invoice.SalesInvoice.Control.DeliverySchedule.ucDeliverySchedule" %>
<script>
