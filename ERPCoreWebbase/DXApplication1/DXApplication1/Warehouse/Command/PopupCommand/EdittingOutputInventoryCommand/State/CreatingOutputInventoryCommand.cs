...
{
    public class CreatingOutputInventoryCommand: NAS.GUI.Pattern.State
    {
        public CreatingOutputInventoryCommand(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        {
            getOwnerUIControl().CRUD_CreatingOutputInventoryCommand();
            return true;
        }

        public override bool UpdateGUI()
        {
            getOwnerUIControl().UpdateGUI_CreatingOutputInventoryCommand();
            return true;
        }
