...
{
    public class SalesOrManufacturerExpense241Strategy: SalesOrManufacturerExpenseStrategy
    {
        private const string ACCOUNT_CODE = "241";

        public SalesOrManufacturerExpense241Strategy(Guid transactionId)
