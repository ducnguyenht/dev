...
{
    public partial class InventoryReceiptStep1 : System.Web.UI.Page, WebModule.Interfaces.IERPCoreWebModuleBase
    {
        ...
        private void BindGrid()
        {
            ...
            grdData.DataSource =
               new[] { 
                     new { key="123", code = "HDP001", date = "25-07-2013", suppliername="Nhà cung cấp 1", rowstatus = "Kích hoạt",
                             description = "Hóa đơn mua hàng"
                    },
                    new { key="1234", code = "HDP002", date = "24-07-2013", suppliername="Nhà cung cấp 2", rowstatus = "Kích hoạt",
                             description = "Hóa đơn mua hàng"
                    },
                };
            ...
            try
            {
                ...
                detailView.DataSource = new[] { 
                    new{sequenceno = "01", productid = "SP00001", productname = "Hàng hóa 1", 
                        productunitid = "Hộp", SoLuong = "500", DonGia  = "5.000", discountcash = "50.000",
                    ...
                    new{sequenceno = "03", productid = "SP00003", productname = "Hàng hóa 3", 
                        productunitid = "Thùng", SoLuong = "500", DonGia  = "5.000", discountcash = "50.000",
