...
{
    public class BookedEntriesInputInventoryCommand : NAS.GUI.Pattern.State
    {
        public BookedEntriesInputInventoryCommand(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        {
            getOwnerUIControl().CRUD_BookedEntriesInputInventoryCommand();
            return true;
        }
