...
{
    public class LegalInvoiceArtifact_Editing : NAS.GUI.Pattern.State 
    {
        ...
        {
            getOwnerUIControl().CRUD_LegalInvoiceArtifact_Editing();
            return true;
        }

        public override bool UpdateGUI()
        {
            getOwnerUIControl().UpdateGUI_LegalInvoiceArtifact_Editing();
            return true;
        }
