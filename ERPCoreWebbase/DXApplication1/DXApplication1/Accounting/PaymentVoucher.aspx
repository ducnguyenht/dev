<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="PaymentVoucher.aspx.cs" Inherits="ERPCore.Accounting.PaymentVoucher" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function grdata_rowclick(s, e) {
            popduyetthuchi.Show();
            cpthuchi.PerformCallback("chi");
        }
    </script>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainHolder" runat="server">
    <div style="margin-bottom: 10px;">
        <dx:ASPxLabel ID="lblHeader" runat="server" Text="Phiếu Chi Tự Động" Font-Bold="True" Font-Size="Small">
        </dx:ASPxLabel>
    </div>
    <table class="style1">
        <tr>
            <td>
                <dx:ASPxGridView ID="grdData" runat="server" AutoGenerateColumns="False" ClientInstanceName="grdData"
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="Mã Phiếu Chi" FieldName="Code" VisibleIndex="0">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Người Nhận Tiền" FieldName="Customer" VisibleIndex="1">
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="Chứng Từ Gốc" FieldName="Order" 
        ...
        <tr>
            <td>
                ...
                <dx:ASPxButton ID="ASPxButton1" runat="server" CssClass="float_right" 
                    Text="Duyệt">
                    <Image>
