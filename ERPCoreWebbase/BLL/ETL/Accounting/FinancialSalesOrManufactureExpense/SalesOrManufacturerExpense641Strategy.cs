...
{
    public class SalesOrManufacturerExpense641Strategy: SalesOrManufacturerExpenseStrategy
    {
        private const string ACCOUNT_CODE = "641";

        public SalesOrManufacturerExpense641Strategy(Guid transactionId)
