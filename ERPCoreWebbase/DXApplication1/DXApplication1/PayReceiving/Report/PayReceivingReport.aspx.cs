...
{
    public partial class PayReceivingReport : System.Web.UI.Page, WebModule.Interfaces.IERPCoreWebModuleBase
    {
        public string AccessObjectId
        {
            get
            {
                return Constant.ACCESSOBJECT_PAYRECEIVE_PAYRECEIVINGREPORT_ID;
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            gvData.DataSource = ReportMappingConstant.PayReceivingDS();
            gvData.DataBind();
