<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Delivery.aspx.cs" Inherits="ERPCore.Purchasing.delivery" %>
<%@ Register src="UserControl/uDeliveryEdit.ascx" tagname="uDeliveryEdit" tagprefix="uc1" %>
<%@ Register src="UserControl/uPurchaseEdit.ascx" tagname="uPurchaseEdit" tagprefix="uc2" %>
...
<div style="">
    ...
    <dx:GridViewDataTextColumn Width="10%" 
            Caption="Ngày " VisibleIndex="1" FieldName="Date"></dx:GridViewDataTextColumn>
    <dx:GridViewDataTextColumn Width="20%" 
            Caption="Nhà Cung Cấp" VisibleIndex="2" FieldName="Supplier"></dx:GridViewDataTextColumn>
...
<SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" 
    ...
    <SettingsPager PageSize="100" Mode="EndlessPaging"></SettingsPager>
