<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uUnitEdit.ascx.cs" Inherits="ERPCore.ImExporting.UserControl.uUnitEdit" %>
<style type="text/css">
    .dxbButton_DevEx
    {
        color: #201f35;
...
<div id="lineContainerUnit">
    <dx:ASPxCallbackPanel ID="cpLineUnit" runat="server" Width="100%" ClientInstanceName="cpLineUnit"
        OnCallback="cpLineUnit_Callback">
        <ClientSideEvents EndCallback="cpLineUnit_EndCallback" />
        <PanelCollection>
                ...
                <dx:ASPxPopupControl ID="formUnitEdit" runat="server" HeaderText="Thông Tin Đơn Vị Tính - "
                    ...
                    <ContentCollection>
                        <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server" SupportsDisabledAttribute="True">
                            <dx:ASPxPageControl ID="ASPxPageControl5" runat="server" ActiveTabIndex="0" Height="100%"
                                Width="100%">
                                <TabPages>
                                    ...
                                    <dx:TabPage Name="tabDetail" Text="Thông Tin Chi Tiết">
                                        <ContentCollection>
                                            <dx:ContentControl ID="ContentControl2" runat="server" SupportsDisabledAttribute="True">
                                                <dx:ASPxNavBar ID="ASPxNavBar1111" runat="server" AutoCollapse="True" Height="100%"
                                                    Width="100%">
                                                    <Groups>
                                                        <dx:NavBarGroup Text="Mô Tả">
                                                            <Items>
                                                                <dx:NavBarItem>
                                                                    <Template>
                                                                        <dx:ASPxHtmlEditor ID="ASPxHtmlEditor3" runat="server" Height="360px" Width="100%">
