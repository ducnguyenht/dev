<%@ Control Language="C#" AutoEventWireup="true" ClientIDMode="AutoID" CodeBehind="uViewIssueCooperativePrinciples.ascx.cs" Inherits="WebModule.GUI.usercontrol.uViewIssueCooperativePrinciples" %>
            ...
            <ContentCollection>
                <dx:ContentControl>
                    ...
                    <dx:ASPxGridView ID="grv_debt" runat="server" KeyFieldName="saleid" Width="100%">
                        <Columns>
                            <dx:GridViewDataTextColumn Caption="Mã phiếu bán" FieldName="saleid" VisibleIndex="0">
                            </dx:GridViewDataTextColumn>
