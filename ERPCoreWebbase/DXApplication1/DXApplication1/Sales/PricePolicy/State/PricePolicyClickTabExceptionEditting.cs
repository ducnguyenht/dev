...
{
    public class PricePolicyClickTabExceptionEditting:NAS.GUI.Pattern.State
    {
        public PricePolicyClickTabExceptionEditting(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        public override bool UpdateGUI()
        {
            ...
            usrc.UpdateGUI_ClickTabExceptionEditting();
            return true;
        }
