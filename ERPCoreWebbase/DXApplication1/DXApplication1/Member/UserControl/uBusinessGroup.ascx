<%@ Control Language="C#" AutoEventWireup="true" ClientIDMode="AutoID" CodeBehind="uBusinessGroup.ascx.cs" Inherits="WebModule.Member.UserControl.uBusinessGroup" %>
                                    ...
                                    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" AlignItemCaptionsInAllGroups="True"
                                        ...
                                        <Items>
                                            <dx:LayoutGroup ShowCaption="False" GroupBoxDecoration="None">
                                                <Items>
                                                    <dx:LayoutItem Caption="Mã nhóm doanh nghiệp" HelpText="Tối đa 128 ký tự">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server"
                                                                SupportsDisabledAttribute="True">
                                                                <dx:ASPxTextBox ID="txtMaNhomDoanhNghiep" runat="server" ClientInstanceName="txtMaNhomDoanhNghiep"
                                                                    Width="200px">
                                                                    <NullTextStyle ForeColor="Silver">
                                                                    </NullTextStyle>
                                                                    <ValidationSettings ErrorText="" SetFocusOnError="True">
                                                                        <RequiredField ErrorText="Chưa nhập mã nhóm doanh nghiệp" IsRequired="True" />
                                                                    </ValidationSettings>
                                                                </dx:ASPxTextBox>
                                                    ...
                                                    <dx:LayoutItem Caption="Tên nhóm doanh nghiệp" HelpText="255 ký tự, không cho phép trùng lắp">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer2" runat="server"
                                                                SupportsDisabledAttribute="True">
                                                                <dx:ASPxTextBox ID="txtTenNhomDoanhNghiep" runat="server" ClientInstanceName="txtTenNhomDoanhNghiep"
                                                                    MaxLength="255" NullText="255 ký tự, không cho phép trùng lắp" Width="400px">
                                                                    <NullTextStyle ForeColor="Silver">
                                                                    </NullTextStyle>
                                                                    <ValidationSettings ErrorText="" SetFocusOnError="True">
                                                                        <RequiredField ErrorText="Chưa nhập tên nhóm doanh nghiệp" IsRequired="True" />
                                                                    </ValidationSettings>
                                                                </dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
