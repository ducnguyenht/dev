...
{
    public class OrderListBooking : NAS.GUI.Pattern.State
    {
        public OrderListBooking(System.Web.UI.Control _UIControl, bool o):  base(_UIControl, o) {}

        public OrderListBooking(System.Web.UI.Control _UIControl) : base(_UIControl) { }
        ...
        {
            return getOwnerUIControl().OrderListBooking_UpdateGUI();
        }
