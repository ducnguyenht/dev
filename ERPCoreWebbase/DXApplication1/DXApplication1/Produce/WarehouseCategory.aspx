<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="WarehouseCategory.aspx.cs" Inherits="WebModule.Produce.WarehouseCategory" %>
    ...
    <td style="vertical-align:top;">
        <div class="gridContainer">
            ...
            <ClientSideEvents CustomButtonClick="grdData_CustomButtonClick" EndCallback="grdData_EndCallback"></ClientSideEvents>
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="Tên Thể Loại Kho" FieldName="name" Name="Name" 
                                ...
                                <dx:GridViewDataTextColumn Caption="Mã Thể Loại Kho" FieldName="code" Name="Code" 
