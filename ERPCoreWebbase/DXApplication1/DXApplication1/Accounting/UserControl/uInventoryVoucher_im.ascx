<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uInventoryVoucher_im.ascx.cs"
    Inherits="WebModule.Accounting.UserControl.uInventoryVoucher_im" %>
...
<dx:ASPxPopupControl ID="ASPxPopupControl1" runat="server" RenderMode="Classic" ShowMaximizeButton="true"
    Width="850px" Height="600px" Modal="true" HeaderText="Hạch toán" ClientInstanceName="poppnk"
    ...
    <FooterContentTemplate>
        <div>
            ...
            <dx:ASPxButton ID="ASPxButton4" AutoPostBack="false" runat="server" CssClass="float-right button-right-margin"
                Text="In phiếu nhập kho" Wrap="False">
                <Image>
    ...
    <ContentCollection>
        <dx:PopupControlContentControl runat="server" SupportsDisabledAttribute="True">
            <dx:ASPxFormLayout ID="ASPxFormLayout2" runat="server" Width="100%">
                <Items>
                    <dx:LayoutGroup Caption="Thông tin phiếu nhập kho" ColCount="2" GroupBoxDecoration="HeadingLine">
                        <Items>
                            ...
                            <dx:LayoutItem Caption="Tổng tiền phiếu nhập kho">
                                <LayoutItemNestedControlCollection>
                            ...
                            <dx:LayoutItem ShowCaption="False">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" 
                                        SupportsDisabledAttribute="True">
                                        <dx:ASPxGridView ID="ASPxGridView_ivi" runat="server" 
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Mục" FieldName="Item" 
                                                    ...
                                                    <FooterTemplate>
                                                        <dx:ASPxTextBox ID="tong" runat="server" Text="Nhập kho hàng" Width="100%">
                                                        </dx:ASPxTextBox>
                                                    </FooterTemplate>
                                                </dx:GridViewDataTextColumn>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="TK có" FieldName="TKco" 
                                                    ...
                                                    <FooterTemplate>
                                                        <dx:ASPxComboBox ID="ASPxComboBox2" runat="server" NullText="" 
            ...
            <%--<dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" AlignItemCaptionsInAllGroups="True"
                AllignItemCaptions="False" ShowItemCaptionColon="False" Width="100%">
                <Items>
                    <dx:LayoutGroup Caption="Thông tin phiếu nhập kho" ColCount="2" GroupBoxDecoration="HeadingLine"
                        Width="100%">
                        <Items>
                            <dx:LayoutItem Caption="Mã chứng từ" ShowCaption="True">
                                <LayoutItemNestedControlCollection>
                            ...
                            <dx:LayoutItem Caption="Ngày nhập" ShowCaption="True">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxDateEdit ID="ASPxFormLayout1_E2" runat="server">
                                        </dx:ASPxDateEdit>
                            ...
                            <dx:LayoutItem Caption="Người tạo" ShowCaption="True">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxComboBox ID="ASPxFormLayout1_E3" runat="server">
                                        </dx:ASPxComboBox>
                            ...
                            <dx:LayoutItem Caption="Lý do" ShowCaption="True">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxComboBox ID="ASPxFormLayout1_E4" runat="server">
                                        </dx:ASPxComboBox>
                            ...
                            <dx:LayoutItem Caption="Tổng tiền phiếu nhập kho" ShowCaption="True">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxTextBox ID="ASPxFormLayout1_E5" runat="server" Width="170px">
                                        </dx:ASPxTextBox>
                    ...
                    <dx:LayoutGroup Caption="Hạch toán" GroupBoxDecoration="HeadingLine" Width="100%">
                        <Items>
                            <dx:LayoutItem ShowCaption="True" Caption="Sơ đồ định khoản">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server"
                                        SupportsDisabledAttribute="True">
                            ...
                            <dx:LayoutItem Caption="Diễn giải" ShowCaption="True">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer2" runat="server"
                                        SupportsDisabledAttribute="True">
                            ...
                            <dx:LayoutItem ShowCaption="False">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxGridView ID="ASPxGridView_ivi" runat="server" AutoGenerateColumns="False"
                                            Width="100%">
                                            <Columns>
                            ...
                            <ContentCollection>
                                <dx:SplitterContentControl ID="SplitterContentControl2" runat="server">
                                    <dx:ReportViewer ID="ReportViewer2" runat="server" Border-BorderStyle="Solid" Border-BorderColor="Black"
                                        Border-BorderWidth="1px" Report="<%# new WebModule.Warehouse.Report._01_VT() %>"
