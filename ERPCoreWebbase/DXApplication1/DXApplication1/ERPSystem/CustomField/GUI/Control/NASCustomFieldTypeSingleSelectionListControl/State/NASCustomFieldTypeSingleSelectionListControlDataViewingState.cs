...
{
    public class NASCustomFieldTypeSingleSelectionListControlDataViewingState : NASCustomFieldTypeControlState
    {
        public NASCustomFieldTypeSingleSelectionListControlDataViewingState(System.Web.UI.Control _UIControl)
            : base(_UIControl)
        { }
        ...
        {
            context.State = new NASCustomFieldTypeSingleSelectionListControlDataEditingState(_UIControl);
            return true;
        }
        #endregion
