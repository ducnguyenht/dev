<%@ Control Language="C#" AutoEventWireup="true" ClientIDMode="AutoID" CodeBehind="uFinishedProductUnitEdit.ascx.cs"
    Inherits="WebModule.Produce.Config.UserControl.uFinishedProductUnitEdit" %>
<style type="text/css">
    .dxbButton_DevEx
    {
        color: #201f35;
...
<div id="lineContainerFinishedProductUnit">
    <dx:ASPxCallbackPanel ID="cbpanelUserFinishedProductUnit" runat="server" Width="850px"
        ClientInstanceName="cbpanelUserFinishedProductUnit" OnCallback="cbpanelUserFinishedProductUnit_Callback">
        <PanelCollection>
            <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
              <dx:ASPxPopupControl ID="formFinishedProductUnitEdit" runat="server" HeaderText="Thông Tin Đơn Vị Tính - "
                    Height="600px" Modal="True" Width="900px" ClientInstanceName="formFinishedProductUnitEdit" AllowDragging="True"
                                    ...
                                    <dx:TabPage Text="Thông Tin Chung">
                                        <ContentCollection>
                                            <dx:ContentControl ID="ContentControl1" runat="server" SupportsDisabledAttribute="True">
                                                <dx:ASPxFormLayout ID="ASPxFo2r11mLayout1" runat="server" 
                                                    ...
                                                    <Items>
                                                        <dx:LayoutGroup ShowCaption="False" GroupBoxDecoration="None">
                                                            <Items>
                                                                ...
                                                                <dx:LayoutItem Caption=" " HelpText="Hình ảnh cho đơn vị tính">
                                                                    <LayoutItemNestedControlCollection>
                                                                        <dx:LayoutItemNestedControlContainer runat="server" 
                                                                            SupportsDisabledAttribute="True">
                                    ...
                                    <dx:TabPage Text="Thông Tin Chi Tiết">
                                        <ContentCollection>
                                            <dx:ContentControl ID="ContentControl2" runat="server" SupportsDisabledAttribute="True">
                                                <dx:ASPxFormLayout ID="sssasdfd" runat="server" Height="100%" 
											Width="100%">
											<Items>
													...
													<LayoutItemNestedControlCollection>
														<dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer3" runat="server" 
															...
															<dx:ASPxLabel ID="ASPxFormLayout2_E1" runat="server" Font-Italic="True" 
																Font-Size="X-Small" ForeColor="#CCCCCC" Text="Mô tả và tài liệu cho ĐVT">
															</dx:ASPxLabel>
														</dx:LayoutItemNestedControlContainer>
													</LayoutItemNestedControlCollection>
