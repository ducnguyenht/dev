...
{
    public class EdittingOutputInventoryCommand : NAS.GUI.Pattern.State
    {
        public EdittingOutputInventoryCommand(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        {
            getOwnerUIControl().CRUD_EdittingOutputInventoryCommand();
            return true;
        }

        public override bool UpdateGUI()
        {
            getOwnerUIControl().UpdateGUI_EdittingOutputInventoryCommand();
            return true;
        }
