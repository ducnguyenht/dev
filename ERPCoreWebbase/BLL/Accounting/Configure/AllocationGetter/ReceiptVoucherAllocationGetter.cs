...
{
    public class ReceiptVoucherAllocationGetter : NAS.BO.Accounting.Configure.AllocationGetter.AllocationGetter
    {
        public override DevExpress.Xpo.XPCollection<Allocation> GetAllocationCollection(Session session)
        {
            try
            {
                AllocationType allocationType =
                    session.FindObject<AllocationType>(new BinaryOperator("Code", "VOUCHER_RECEIPT"));
