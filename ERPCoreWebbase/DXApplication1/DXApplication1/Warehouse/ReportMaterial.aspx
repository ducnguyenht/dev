<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="ReportMaterial.aspx.cs" Inherits="WebModule.Warehouse.ReportMaterial" %>
...
<script type="text/javascript">
    ...
    function ShowPopup(productName) {
        ...
        pcReportViewerPopup.SetHeaderText("Báo cáo tồn nguyên vật liệu: " + productName);
        reportType.Set('ReportType', "ReportProduct");
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainHolder" runat="server">
	...
	grid_CustomButtonClick(s, e);
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="Tên nguyên vật liệu" FieldName="name" 
                VisibleIndex="1">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Mã nguyên vật liệu" FieldName="code" 
                VisibleIndex="0">
            </dx:GridViewDataTextColumn>
        </Columns>
