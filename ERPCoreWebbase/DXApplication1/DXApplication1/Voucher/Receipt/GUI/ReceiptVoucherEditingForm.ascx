<%@ Control Language="C#" ClientIDMode="AutoID" AutoEventWireup="true" CodeBehind="ReceiptVoucherEditingForm.ascx.cs"
    Inherits="WebModule.Voucher.Receipt.GUI.ReceiptVoucherEditingForm" %>
...
<script type="text/javascript">
    ...
    function popupReceiptVoucherEditingForm_Closing(s, e) {
        ReceiptVoucherEditingForm.Cancel();
    }
    ...
    var CPNumberString_PendingCallback;
    function ConvertedAmount_Update(s, e) {
        ReCalculate_ConvertedAmount();
//        if (CPNumberString.InCallback()) 
//            CPNumberString_PendingCallback = s.GetValue();
//        else
            CPNumberString.PerformCallback();
    }

    function CPNumberString_EndCallback(s, e) {
//        if (CPNumberString_PendingCallback) {
//            CPNumberString.PerformCallback(CPNumberString_PendingCallback);
//            CPNumberString_PendingCallback = null;
//        }
    }
...
<dx:ASPxCallbackPanel ID="cpnReceiptVoucherEditingForm" ClientInstanceName="cpnReceiptVoucherEditingForm"
    ...
    <PanelCollection>
        <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
            ...
            <dx:ASPxPopupControl ID="popupReceiptVoucherEditingForm" runat="server" AllowDragging="True" 
                ClientInstanceName="popupReceiptVoucherEditingForm"
                ...
                <ContentCollection>
                    <dx:PopupControlContentControl runat="server" SupportsDisabledAttribute="True">
                        <dx:XpoDataSource ID="dsReceiptVoucher" runat="server" Criteria="[VouchesId] = ?"
                            TypeName="NAS.DAL.Vouches.ReceiptVouches">
                        </dx:XpoDataSource>
                        <dx:XpoDataSource ID="dsVoucherAmount" runat="server" Criteria="[VouchesId!Key] = ?"
                            TypeName="NAS.DAL.Vouches.VouchesAmount" DefaultSorting="">
                        </dx:XpoDataSource>
                                            ...
                                            <dx:ASPxFormLayout ID="formlayoutReceiptVoucherEditingForm" runat="server" DataSourceID="dsReceiptVoucher"
                                                ...
                                                <Items>
                                                    <dx:LayoutGroup Caption="Thông tin chung" ColCount="4">
                                                        <Items>
                                                            <dx:LayoutItem Caption="Số phiếu thu" ColSpan="2" FieldName="Code" RequiredMarkDisplayMode="Required">
                                                                            ...
                                                                            <PanelCollection>
                                                                                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                                                                    <dx:ASPxTextBox ID="txtCode" runat="server" ClientInstanceName="txtCode" OnValidation="txtCode_Validation"
                                                                                        ...
                                                                                        <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ValidationGroup="ReceiptVoucherEditingForm">
                                                            ...
                                                            <dx:LayoutItem Caption="Ngày thu" ColSpan="2" FieldName="IssuedDate" RequiredMarkDisplayMode="Required">
                                                                <LayoutItemNestedControlCollection>
                                                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                                            ...
                                                            <dx:LayoutItem Caption="Đơn vị nộp tiền" ColSpan="2" FieldName="SourceOrganizationId!Key">
                                                                <LayoutItemNestedControlCollection>
                                                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                                                        <dx:ASPxComboBox ID="cboSourceOrganization" runat="server" CallbackPageSize="10"
                                                                            ...
                                                                            <Columns>
                                                                                <dx:ListBoxColumn Caption="Mã đơn vị nộp tiền" FieldName="Code" />
                                                                                <dx:ListBoxColumn Caption="Tên đơn vị nộp tiền" FieldName="Name" />
                                                            ...
                                                            <dx:LayoutItem Caption="Người nộp tiền" ColSpan="2" FieldName="Payer">
                                                                <LayoutItemNestedControlCollection>
                                                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                                            ...
                                                            <dx:LayoutItem Caption="Lý do nộp" ColSpan="4" FieldName="Description">
                                                                <LayoutItemNestedControlCollection>
                                                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                                ...
                                                <PanelCollection>
                                                    <dx:PanelContent>
                                                        <dx:ASPxFormLayout ID="formlayoutVoucherAmount" runat="server" Width="100%" DataSourceID="dsVoucherAmount">
                                                            <Items>
                                                                <dx:LayoutGroup Caption="Thông tin số tiền thu" ColCount="4">
                                                                    <Items>
                                                                        <dx:LayoutItem Caption="Số tiền" RequiredMarkDisplayMode="Required" FieldName="Debit">
                                                                            <LayoutItemNestedControlCollection>
                                                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server"
                                                                                    ...
                                                                                    <dx:ASPxSpinEdit ID="spinAmount" ClientInstanceName="spinAmount" runat="server" Height="21px"
                                                                                        ...
                                                                                        <ValidationSettings ValidationGroup="ReceiptVoucherEditingForm" ErrorDisplayMode="ImageWithTooltip">
                                                                        ...
                                                                        <dx:LayoutItem Caption="Loại tiền tệ" RequiredMarkDisplayMode="Required" FieldName="ForeignCurrencyId!Key">
                                                                            <LayoutItemNestedControlCollection>
                                                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer2" runat="server"
                                                                                    SupportsDisabledAttribute="True">
                                                                                    <uc3:CurrencyGridLookup ID="gridlookupCurrency" runat="server" ValidationSettings-Display="Dynamic"
                                                                                        ValidationSettings-ErrorDisplayMode="ImageWithTooltip" ValidationSettings-ValidationGroup="ReceiptVoucherEditingForm"
                                                                                        ValidationSettings-RequiredField-IsRequired="true" ValidationSettings-RequiredField-ErrorText="<%$ Resources:MessageResource, Msg_Required_Select %>"
                                                                                        ClientSideEvents-ValueChanged="gridlookupCurrency_ValueChanged">
                                                                                    </uc3:CurrencyGridLookup>
                                                                                </dx:LayoutItemNestedControlContainer>
                                                                            </LayoutItemNestedControlCollection>
                                                                        </dx:LayoutItem>
                                                                        <dx:LayoutItem Name="ExchangeRate" Caption="Tỉ giá" RequiredMarkDisplayMode="Required"
                                                                        ...
                                                                        <dx:LayoutItem Name="ConvertedAmount" Caption="Số tiền qui đổi" FieldName="VouchesId.SumOfDebit">
                                                                            <LayoutItemNestedControlCollection>
                                                                            ...
                                                                            <LayoutItemNestedControlCollection>
                                                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer5" runat="server"
                                                                                    ...
                                                                                    <dx:ASPxCallbackPanel ID="CPNumberString" ClientInstanceName="CPNumberString" runat="server" Width="100%" 
                                                                                        ...
                                                                                        <ClientSideEvents EndCallback="CPNumberString_EndCallback" />
                                                                                        <PanelCollection>
                                                                                            <dx:PanelContent>
