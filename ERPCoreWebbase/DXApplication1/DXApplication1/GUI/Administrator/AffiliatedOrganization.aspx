<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="AffiliatedOrganization.aspx.cs" Inherits="DXApplication1.GUI.Administrator.AffiliatedOrganization" %>
                ...
                <ContentCollection>
                    <dx:SplitterContentControl ID="SplitterContentControl1" runat="server" SupportsDisabledAttribute="True">
                        <cc:ContentTitle ID="titlePage" runat="server" CssClass="content-title" ParentTitleSize="16px"
                            Style="display: block;" Title="Các tổ chức trực thuộc Công ty CP TM Dược Sâm Ngọc Linh Quảng Nam"
                            TitleSize="26px" />
    ...
    <dx:ASPxPopupControl ID="pcRolesOfOrganization" runat="server" RenderMode="Lightweight"
        ...
        <ContentCollection>
            <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server" SupportsDisabledAttribute="True">
                ...
                &nbsp;<dx:ASPxLabel ID="ASPxLabel2" runat="server" Font-Size="16px" Text="Đại lý 1">
                </dx:ASPxLabel>
                <br />
                <br />
        ...
        <ContentCollection>
            <dx:PopupControlContentControl ID="PopupControlContentControl2" runat="server" SupportsDisabledAttribute="True">
                <dx:ASPxLabel ID="ASPxLabel3" runat="server" Font-Bold="False" Font-Size="16px" ForeColor="Black"
                    Text="Chi tiết vai trò Đại lý 1">
                </dx:ASPxLabel>
                <br />
                <br />
