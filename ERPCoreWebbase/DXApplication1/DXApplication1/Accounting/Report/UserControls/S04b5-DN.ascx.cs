...
{
    public partial class S04b5_DN : System.Web.UI.UserControl
    {
        Session session;
        protected void Page_Init(object sender, EventArgs e)
        {
            session = XpoHelper.GetNewSession();
            if (hS04b5dn.Contains("show"))
            {
                load_data();
            }
        }
        ...
        public void load_data()
        {
            ...
            s04b5_dn.printableCC_S04b5DN.PrintableComponent = new PrintableComponentLinkBase() { Component = GridViewExporter_S04b5DN };
            ReportViewer_S04b5DN.Report = s04b5_dn;
            #endregion
        }
        #endregion

        // TK header (correspond f & c)
        public List<string> list_header()
        {
            ...
            if (md != null && yd != null && ood != null)
            {
                ...
                // 241 641 642
                support_list_header("241", FinancialFact_General, CorrespondFinancialAccountDimId_default, list_header);
                support_list_header("641", FinancialFact_General, CorrespondFinancialAccountDimId_default, list_header);
                support_list_header("642", FinancialFact_General, CorrespondFinancialAccountDimId_default, list_header);
                //
            }
            list_header.Sort();
            return list_header;
        ...
        public void grid_header()
        {
            ...
            GridView_S04b5DN.Columns.Add(fieldColumn);
            ...
            fieldColumn = new GridViewDataTextColumn { FieldName = "cong_tt", Caption = "Cộng chi phí thực tế trong kỳ" };
            fieldColumn.PropertiesEdit.DisplayFormatString = "#,#";
            bandColumn.Columns.Add(fieldColumn);
            GridView_S04b5DN.Columns.Add(bandColumn);
        }
