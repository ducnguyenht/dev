...
{
    public class SalesOrManufacturerExpense627Strategy : SalesOrManufacturerExpenseStrategy
    {
        private const string ACCOUNT_CODE = "627";

        public SalesOrManufacturerExpense627Strategy(Guid transactionId)
