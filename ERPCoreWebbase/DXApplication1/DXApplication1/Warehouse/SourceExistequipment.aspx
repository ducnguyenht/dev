<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="SourceExistequipment.aspx.cs" Inherits="WebModule.Warehouse.SourceExistequipment" %>
<%@ Register src="~/Purchasing/UserControl/uBuyingDevice.ascx" tagname="uWarehouse" tagprefix="uc1" %>
...
<div style="margin-bottom:10px;">
	...
	if (s.cpNew) {
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="Mã CCDC" FieldName="code" VisibleIndex="0">
