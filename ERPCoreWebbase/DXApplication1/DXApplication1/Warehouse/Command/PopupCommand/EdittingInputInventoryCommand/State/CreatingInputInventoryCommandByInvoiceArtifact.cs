...
{
    public class CreatingInputInventoryCommandByInvoiceArtifact : NAS.GUI.Pattern.State
    {
        public CreatingInputInventoryCommandByInvoiceArtifact(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        {
            getOwnerUIControl().CRUD_CreatingInputInventoryCommandByArtifact();
            return true;
        }
