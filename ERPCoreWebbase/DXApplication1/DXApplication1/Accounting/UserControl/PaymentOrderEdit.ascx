<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentOrderEdit.ascx.cs" Inherits="ERPCore.Accounting.UserControl.PaymentOrderEdit" %>
...
<dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
    <dx:ASPxPopupControl ID="formPaymentOrderEdit" runat="server" Width="850px" 
        ClientInstanceName="formPaymentOrderEdit" HeaderText="Nội dung ủy nhiệm chi" 
