...
{
    public class BookedEntriesOutputInventoryCommand : NAS.GUI.Pattern.State
    {
        public BookedEntriesOutputInventoryCommand(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        {
            getOwnerUIControl().CRUD_BookedEntriesOutputInventoryCommand();
            return true;
        }
