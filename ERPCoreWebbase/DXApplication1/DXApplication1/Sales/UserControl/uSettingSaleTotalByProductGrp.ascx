<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uSettingSaleTotalByProductGrp.ascx.cs" Inherits="WebModule.GUI.Sales.userControl.uSettingSaleTotalByProductGrp" %>
<script type="text/javascript">
    function show_uSettingSaleTotalByProductGrp(s, e) {
        popup_settingSalesTotalByproGrp.Show();
    }
</script>
<dx:ASPxPopupControl ID="popup_settingSalesTotalByproGrp" runat="server" CloseAction="CloseButton" Modal="true"
    ClientInstanceName="popup_settingSalesTotalByproGrp" AllowDragging="True" AllowResize="True" 
    PopupAnimationType="None" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter"
    EnableViewState="False" HeaderText="Áp dụng điều kiện doanh số cho nhóm hàng hóa" Width="850px" Height="400px" ScrollBars="Auto" ShowFooter="true">
    <ContentCollection>
