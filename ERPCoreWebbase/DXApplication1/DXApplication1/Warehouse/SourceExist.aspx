<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="SourceExist.aspx.cs" Inherits="WebModule.Warehouse.SourceExist" %>
<%@ Register src="UserControl/uSourceExist.ascx" tagname="uSourceExist" tagprefix="uc1" %>
<%@ Register src="~/Purchasing/UserControl/uProductEdit.ascx" tagname="uWarehouse" tagprefix="uc2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadHolder" runat="server">

</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainHolder" runat="server">
<div style="margin-bottom:10px;">
    <dx:ASPxLabel ID="lblHeader" runat="server" Text="Danh sách hàng hóa" 
