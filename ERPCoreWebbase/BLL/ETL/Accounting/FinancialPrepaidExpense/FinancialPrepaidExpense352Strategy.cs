...
{
    public class FinancialPrepaidExpense352Strategy : FinancialPrepaidExpenseStrategy
    {
        private const string ACCOUNT_CODE = "352";

        public FinancialPrepaidExpense352Strategy(Guid transactionId)
