...
using NAS.BO.ETL.Accounting.FinancialActualPrice;
...
{
    class ActualPriceJob: IETLJob
    {
        public string JobRegisterCode
        {
            get { return "ActualPriceJob"; }
        }
        ...
        public void Extract()
        {
            ...
            Strategies.Add(new FinancialActualPrice152Strategy(RefId));
            Strategies.Add(new FinancialActualPrice153Strategy(RefId));
            Strategies.Add(new FinancialActualPrice155Strategy(RefId));
            Strategies.Add(new FinancialActualPrice156Strategy(RefId));
            Strategies.Add(new FinancialActualPrice158Strategy(RefId));
