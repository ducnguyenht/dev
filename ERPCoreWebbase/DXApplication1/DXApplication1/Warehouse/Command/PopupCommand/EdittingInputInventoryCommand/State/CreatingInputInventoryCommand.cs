...
{
    public class CreatingInputInventoryCommand: NAS.GUI.Pattern.State
    {
        public CreatingInputInventoryCommand(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        {
            getOwnerUIControl().CRUD_CreatingInputInventoryCommand();
            return true;
        }

        public override bool UpdateGUI()
        {
            getOwnerUIControl().UpdateGUI_CreatingInputInventoryCommand();
            return true;
        }
