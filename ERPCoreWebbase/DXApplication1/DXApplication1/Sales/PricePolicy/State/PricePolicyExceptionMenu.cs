...
{
    public class PricePolicyExceptionMenu : NAS.GUI.Pattern.State
    {
        public PricePolicyExceptionMenu(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        public override bool UpdateGUI()
        {
            ...
            usrc.UpdateGUI_ExceptionMenuUpdating();
            return true;
        }
