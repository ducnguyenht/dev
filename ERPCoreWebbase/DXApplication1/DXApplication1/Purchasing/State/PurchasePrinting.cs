...
{
    public class PurchasePrinting : NAS.GUI.Pattern.State
    {
        public PurchasePrinting(System.Web.UI.Control _UIControl, bool o):  base(_UIControl, o) {}        

        public PurchasePrinting(System.Web.UI.Control _UIControl) : base(_UIControl) { }
        ...
        {
            return getOwnerUIControl().PurchasePrinting_UpdateGUI();
        }
