...
{
    public partial class GrossSplitPurchase : System.Web.UI.Page, WebModule.Interfaces.IERPCoreWebModuleBase
    {
        public string AccessObjectId
        {
            get
            {
                return Constant.ACCESSOBJECT_ACCOUNT_GROSSSPLITPURCHASE_ID;
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            grdData0.DataSource =
              new[] { 
                     new { key="123", code = "ML0001", supplier = "Nhà cung cấp 1", date = "25-07-2013", order="1",
                             status="Dang dở", sum="1.000.000"
                    },
                    new { key="1234", code = "ML0002", supplier = "Nhà cung cấp 2", date = "28-07-2013", order="2",
            ...
            grdData.DataSource =
              new[] { 
                     new { key="123", code = "MAT001", supplier = "Nhà cung cấp 1", date="25-07-2013", reciept = "HD001",
                             recieptamount="100", realamount="90", difamount="10", unit="Thùng", description = "Mặt hàng 1"
                    },
                    new { key="1234", code = "MAT002", supplier = "Nhà cung cấp 2", date="28-02-2013", reciept = "HD001",
