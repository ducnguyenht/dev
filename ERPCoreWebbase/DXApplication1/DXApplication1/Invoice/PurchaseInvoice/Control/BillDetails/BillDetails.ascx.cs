...
using WebModule.Invoice.PurchaseInvoice.Control.BillDetails.State;
...
namespace WebModule.Invoice.PurchaseInvoice.Control.BillDetails
{
    public partial class BillDetails : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (url.Contains("Invoice/PurchaseInvoice/GUI/MaterialPurchaseInvoiceListingForm.aspx"))
            {
            ...
            else if (url.Contains("Invoice/PurchaseInvoice/GUI/FixedAssetsPurchaseInvoiceListingForm.aspx"))
            {
        ...
        private void LoadDataOnBillItemsState()
        {
            if (BillId != null)
            {
                ...
                billItemEditForm.SetBillItemEditFormStrategy(new PurchaseInvoiceBillItemEditFormStrategy());
                switch (BillType)
                {
