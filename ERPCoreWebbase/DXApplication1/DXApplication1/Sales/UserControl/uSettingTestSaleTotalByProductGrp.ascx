<%@ Control Language="C#" AutoEventWireup="true" ClientIDMode="AutoID" CodeBehind="uSettingTestSaleTotalByProductGrp.ascx.cs" Inherits="WebModule.GUI.Sales.userControl.uSettingTestSaleTotalByProductGrp" %>
<script type="text/javascript">
    function show_uSettingTestSaleTotalByProductGrp(s, e) {
        popup_settingTestSalesTotalByproGrp.Show();
    }
</script>
<dx:ASPxPopupControl ID="popup_settingTestSalesTotalByproGrp" runat="server" CloseAction="CloseButton" Modal="true"
    ClientInstanceName="popup_settingTestSalesTotalByproGrp" AllowDragging="True" AllowResize="True" 
    PopupAnimationType="None" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter"
    EnableViewState="False" HeaderText="Giả lập doanh số theo nhóm hàng hóa" Width="850px" Height="400px" ScrollBars="Auto" ShowFooter="true">
    <ContentCollection>
        <dx:PopupControlContentControl runat="server" SupportsDisabledAttribute="True">
            <dx:ASPxGridView ID="grv_settingSalesTotalByproGrp" ClientInstanceName="grv_settingSalesTotalByproGrp" 
                runat="server" AutoGenerateColumns="False" KeyFieldName="SupplierId" Width="100%">
                <Columns>
                    <dx:GridViewDataTextColumn Caption="Mã Nhóm" FieldName="Code" 
                        Name="Code" Width="90px" VisibleIndex="0">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Tên Nhóm" FieldName="Name" 
