...
{
    public class SavingInputInventoryCommand : NAS.GUI.Pattern.State
    {
        public SavingInputInventoryCommand(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        {
            getOwnerUIControl().CRUD_SavingInputInventoryCommand();
            return true;
        }

        public override bool UpdateGUI()
        {
            getOwnerUIControl().UpdateGUI_SavingInputInventoryCommand();
            return true;
        }
