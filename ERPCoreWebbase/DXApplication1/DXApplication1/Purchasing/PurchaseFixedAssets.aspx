<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="PurchaseFixedAssets.aspx.cs" Inherits="WebModule.Purchasing.PurchaseFixedAssets" %>
<%@ Register Src="UserControl/uPurchaseFixedAssestsEdit.ascx" TagName="uPurchaseFixedAssestsEdit" TagPrefix="uc1" %>
...
<div style="margin-bottom: 10px;">
    <dx:ASPxLabel ID="lblHeader" runat="server" Text="Phiếu Mua Tài Sản Cố Định" Font-Bold="True"
        Font-Size="Small">
    </dx:ASPxLabel>
</div>
...
<tr>
    <td>
         <uc1:uPurchaseFixedAssestsEdit ID="uPurchaseFixedAssestsEdit1" runat="server" />
    </td>
</tr>
<tr>
    <td>               
