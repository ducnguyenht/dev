...
namespace WebDemo1.Web
{
    ...
    public partial class WebDemo1AspNetApplication : WebApplication
    {
        ...
        private WebDemo1.Module.Web.WebDemo1AspNetModule module4;

        public WebDemo1AspNetApplication()
        {
            InitializeComponent();
        }
        ...
        private void WebDemo1AspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
        {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
        ...
        private void InitializeComponent()
        {
            ...
            this.module4 = new WebDemo1.Module.Web.WebDemo1AspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.WebDemo1AspNetApplication_DatabaseVersionMismatch);
