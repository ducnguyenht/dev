<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uPurchaseMaterialsEdit.ascx.cs" Inherits="WebModule.Purchasing.UserControl.uPurchaseMaterialsEdit" %>
    ...
    <dx:ASPxCallbackPanel ID="cpLine" runat="server" Width="100%" ClientInstanceName="cpLine">
        <PanelCollection>
            <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                <dx:ASPxPopupControl ID="formPurchaseEdit" runat="server" HeaderText="Thông Tin Phiếu Mua Nguyên Vật Liệu - "
                    ...
                    <ContentCollection>
                        <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server" SupportsDisabledAttribute="True">
                            ...
                            <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" Height="70%"
                                ...
                                <TabPages>
                                    <dx:TabPage Name="tabGeneral" Text="Nguyên Vật Liệu">
                                        <ContentCollection>
                                            <dx:ContentControl ID="ContentControl1" runat="server" SupportsDisabledAttribute="True">
                                                <dx:ASPxGridView ID="grdBuyingProductCategory3" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        <dx:GridViewDataComboBoxColumn Caption="Mã NVL" ShowInCustomizationForm="True" VisibleIndex="1"
                                                            Width="150px">
                                                            <PropertiesComboBox>
                                                                <Columns>
                                                                    <dx:ListBoxColumn Caption="Mã NVL" FieldName="Code" Name="Code" Width="150px" />
                                                                    <dx:ListBoxColumn Caption="Tên NVL" FieldName="Name" Name="Name" 
                                                                        Width="300px" />
                                                                </Columns>
                                                            </PropertiesComboBox>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Tên NVL" ShowInCustomizationForm="True" 
                                                ...
                                                <dx:ASPxFormLayout ID="ASPxFormLayout2" runat="server" ColCount="2">
                                                    <Items>
                                                        ...
                                                        <dx:LayoutItem Caption="Tổng tiền thanh toán (NVL)">
                                                            <LayoutItemNestedControlCollection>
                                            ...
                                            <dx:ContentControl ID="ContentControl2" runat="server" SupportsDisabledAttribute="True">
                                                <dx:ASPxGridView ID="grdBuyingProductCategory" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Đơn Giá" ShowInCustomizationForm="True" VisibleIndex="3"
                                                            Width="150px">
                                                        </dx:GridViewDataTextColumn>
                                                        ...
                                                        <dx:LayoutItem Caption="Chiết khấu (%)">
                                                            <LayoutItemNestedControlCollection>
                                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer11" runat="server"
                                                                    SupportsDisabledAttribute="True">
                                                                    <dx:ASPxSpinEdit ID="txtProductDiscountAmount" ClientInstanceName="txtProductDiscountAmount" 
                                                                        runat="server" Height="21px" Number="0" 
                                                                        Width="80px" DisplayFormatString="n2" NullText="0">
                                                        ...
                                                        <dx:LayoutItem Caption="Tiền CK">
                                                            <LayoutItemNestedControlCollection>
                                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer12" runat="server"
                                                                    SupportsDisabledAttribute="True">
                                                                    <dx:ASPxSpinEdit ID="txtProductDiscountSum" runat="server" Height="21px" Number="0" 
                                                                        Width="200px" ClientInstanceName="txtProductDiscountSum" 
                                                        ...
                                                        <dx:LayoutItem Caption="Thuế GTGT (%)">
                                                            <LayoutItemNestedControlCollection>
                                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer13" runat="server"
                                                                    SupportsDisabledAttribute="True">
                                                                    <dx:ASPxSpinEdit ID="txtProductTax" 
                                                                        ClientInstanceName="txtProductTax" runat="server" 
                                                                        DisplayFormatString="n2" Height="21px" Number="0" Width="80px" 
                                                                        NullText="0">
                                                            ...
                                                            <LayoutItemNestedControlCollection>
                                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer14" runat="server"
                                                                    ...
                                                                    <dx:ASPxSpinEdit ID="txtProductTaxValue" runat="server" 
                                                                        ClientInstanceName="txtProductTaxValue" DisplayFormatString="n2" Height="21px" 
                                                                        Number="0" Width="200px" NullText="0" ReadOnly="True">
                                                                    </dx:ASPxSpinEdit>
                                                                </dx:LayoutItemNestedControlContainer>
                                                            </LayoutItemNestedControlCollection>
                                                        </dx:LayoutItem>
                                                            ...
                                                            <LayoutItemNestedControlCollection>
                                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer16" runat="server" 
                                                                    ...
                                                                    <dx:ASPxSpinEdit ID="txtProductTotal" runat="server" 
                                                                        ClientInstanceName="txtProductTotal" Height="21px" Number="0" ReadOnly="True" 
                                                                        Width="200px" DisplayFormatString="n2" NullText="0">
                                                                    </dx:ASPxSpinEdit>
                                                                </dx:LayoutItemNestedControlContainer>
                                                            </LayoutItemNestedControlCollection>
                                                        </dx:LayoutItem>
                                                                                ...
                                                                                <td class="style72" rowspan="3" valign="top">
                                                                                    <dx:ASPxRadioButtonList ID="ASPxRadioButtonList1" runat="server" Width="100%">
                                                                                        <Items>
                                                                                            ...
                                                                                            <dx:ListEditItem Text="CK Theo Từng Nguyên Vật Liệu" Value="CK Theo Từng" />
                                                                                        </Items>
                                                                                ...
                                                                                <td>
                                                                                    <dx:ASPxGridView ID="grdProductSupplier" runat="server" AutoGenerateColumns="False"
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <dx:GridViewDataTextColumn Caption="Nguyên Vật Liệu" FieldName="SupplierName" Name="SupplierName"
