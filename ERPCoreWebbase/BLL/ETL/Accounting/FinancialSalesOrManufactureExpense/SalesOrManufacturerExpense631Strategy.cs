...
{
    public class SalesOrManufacturerExpense631Strategy : SalesOrManufacturerExpenseStrategy
    {
        private const string ACCOUNT_CODE = "631";

        public SalesOrManufacturerExpense631Strategy(Guid transactionId)
