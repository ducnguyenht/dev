<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uActiveElement.ascx.cs" Inherits="WebModule.Purchasing.UserControl.uActiveElement" %>
<style type="text/css">
    .float_right
    {
        float: right;
...
<script type="text/javascript">
    ...
    var ManufacturerCategoryEditForm = {
        Show: function (recordId, Code) {
            if (recordId) {
                this._recordId = recordId;
                popManufacturerGroupEdit.SetHeaderText("Sửa Thông Tin Hoạt Chất - Mã Số: " + Code);
                popManufacturerGroupEdit.PerformCallback('edit' + '|' + recordId);
            }
            else {
                this._recordId = null;
                popManufacturerGroupEdit.SetHeaderText("Thêm Mới Hoạt Chất");
        ...
        Save: function () {
            /////2013-09-20 ERP-572 Khoa.Truong MOD START
            ...
            /////2013-09-20 ERP-572 Khoa.Truong MOD END
        },
        ...
        switch (s.name) {
            case '<%= txtCode.ClientID %>':
                ...
                if (code.length > CODE_MAX_LENGTH) {
                    e.isValid = false;
                    e.errorText = "Mã hoạt chất không được vượt quá 128 kí tự";
                }
                if (e.isValid == true) {
            ...
            case '<%= txtName.ClientID %>':
                ...
                if (name.length > NAME_MAX_LENGTH) {
                    e.isValid = false;
                    e.errorText = "Tên hoạt chất không được vượt quá 255 kí tự";
                }
                break;
            default:
                break;
    ...
    <dx:ASPxCallbackPanel ID="cpLineManufacturerGroup" runat="server" Width="100%" ClientInstanceName="cpLineManufacturerGroup"
        ...
        <PanelCollection>
            <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                <dx:ASPxPopupControl ID="popManufacturerGroupEdit" runat="server" HeaderText="Thông Tin Hoạt Chất - "
                    ...
                    OnWindowCallback="popManufacturerGroupEdit_WindowCallback" 
                        ...
                        <div id="Footer" style="display: inline; width: 100%;">
                            ...
                            <div style="display: inline; float: right;">
                                <dx:ASPxButton ID="buttonCancelDevice" runat="server" AutoPostBack="False" CssClass="float_right dl mg"
                                    ClientInstanceName="btnCancel" Text="Thoát" Wrap="False" ToolTip="Thoát  - Ctrl + C">
                                    <Image>
                    ...
                    <ContentCollection>
                        <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server" SupportsDisabledAttribute="True">
                            <dx:XpoDataSource ID="dsManufacturerCategory" runat="server" 
                                TypeName="DAL.Purchasing.ViewManufacturerCategory" 
                                Criteria="[ManufacturerCategoryId] = ?">
                                <CriteriaParameters>
                                    <asp:Parameter Name="ManufacturerCategoryId" />
                                </CriteriaParameters>
                            </dx:XpoDataSource>
                            <dx:ASPxPageControl ID="pagManufacturerGroupEdit" ClientInstanceName="pagManufacturerGroupEdit" runat="server" 
                                    ...
                                    <dx:TabPage Name="tabGeneral" Text="Thông Tin Chung">
                                        <ContentCollection>
                                            <dx:ContentControl ID="ContentControl1" runat="server" SupportsDisabledAttribute="True">
                                                <dx:ASPxFormLayout ID="frmlActiveElement" runat="server" Width="100%">
                                                    <Items>
                                                        <dx:LayoutGroup ShowCaption="False">
                                                            <Items>
                                                                <dx:LayoutItem Caption="Mã hoạt chất" RequiredMarkDisplayMode="Required" 
                                                                                ...
                                                                                <PanelCollection>
                                                                                    <dx:PanelContent>
                                                                                        <dx:ASPxTextBox ID="txtCode" runat="server" Width="200px" OnValidation="txtCode_Validation">
                                                                                            <ClientSideEvents Validation="ValidateForm" />
                                                                                            <ValidationSettings ErrorDisplayMode="ImageWithText" ErrorText="">
                                                                                                <RequiredField IsRequired="True" ErrorText="Chưa nhập mã hoạt chất"></RequiredField>
                                                                                            </ValidationSettings>
                                                                                        </dx:ASPxTextBox>
                                                                                    </dx:PanelContent>
                                                                                </PanelCollection>
                                                                ...
                                                                <dx:LayoutItem Caption="Tên hoạt chất" RequiredMarkDisplayMode="Required" 
                                                                    ...
                                                                    <LayoutItemNestedControlCollection>
                                                                        <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer2" runat="server" SupportsDisabledAttribute="True">
                                                                            <dx:ASPxTextBox ID="txtName" runat="server" Width="400px">
                                                                                <ClientsideEvents Validation="ValidateForm" />
                                                                                <ValidationSettings ErrorDisplayMode="ImageWithText" ErrorText="">
                                                                                    <RequiredField IsRequired="True" ErrorText="Chưa nhập tên hoạt chất"></RequiredField>
                                                                                </ValidationSettings>
                                                                            </dx:ASPxTextBox>
                                                                        </dx:LayoutItemNestedControlContainer>
                                                                    </LayoutItemNestedControlCollection>
                                                                </dx:LayoutItem>
                                                                <dx:LayoutItem Caption="Trạng thái" HelpText="Trạng thái của nhóm nhà sản xuất" 
                                                                    FieldName="RowStatus">
                                                                    <LayoutItemNestedControlCollection>
                                                                ...
                                                                <dx:LayoutItem Caption="   " ShowCaption="True" 
                                                                    HelpText="Hình ành cho nhà sản xuất" Visible="False">
                                                                    <LayoutItemNestedControlCollection>
