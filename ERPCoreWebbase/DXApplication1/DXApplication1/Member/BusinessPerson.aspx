<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="BusinessPerson.aspx.cs" Inherits="WebModule.Member.BusinessPerson" %>
<%@ Register Src="UserControl/uBusinessPerson.ascx" TagName="uBusinessPerson" TagPrefix="uc1" %>
<%@ Register Src="UserControl/uBusinessPersonGroup.ascx" TagName="uBusinessPersonGroup" TagPrefix="uc2" %>
...
<dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" RenderMode="Lightweight"
    Width="100%">
    <TabPages>
        <dx:TabPage Text="Doanh nhân">
            <ContentCollection>
                <dx:ContentControl ID="ContentControl1" runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxGridView ID="grdDoanhNhan" runat="server" AutoGenerateColumns="False" Width="100%">
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="Tên doanh nhân" FieldName="tendn" ShowInCustomizationForm="True"
                                VisibleIndex="1" Name="tenDN">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Mã doanh nhân" FieldName="madn" ShowInCustomizationForm="True"
                    ...
                    <br />
                    <dx:ASPxPopupControl ID="formEditDN" runat="server" HeaderText="Thông tin doanh nhân"
                        ...
                        <ContentCollection>
                            <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server" SupportsDisabledAttribute="True">
                                <uc1:uBusinessPerson ID="uBusinessPerson" runat="server" />
        ...
        <dx:TabPage Text="Nhóm doanh nhân">
            <ContentCollection>
                <dx:ContentControl ID="ContentControl2" runat="server" SupportsDisabledAttribute="True">
                    <dx:ASPxGridView ID="grdNhomDN" runat="server" AutoGenerateColumns="False" KeyFieldName="SupplierId"
                        Width="100%">
                        <Columns>
                            <dx:GridViewDataTextColumn Caption="Tên Nhóm doanh nhân" FieldName="tennhomdn" Name="tenNhomDN"
                            ...
                            <dx:GridViewDataTextColumn Caption="Mã Nhóm doanh nhân" FieldName="manhomdn" Name="maNhomDN"
...
<dx:ASPxPopupControl ID="formEditNhomDN" runat="server" HeaderText="Thông tin nhóm doanh nhân"
    ...
    <ContentCollection>
        <dx:PopupControlContentControl ID="PopupControlContentControl2" runat="server" SupportsDisabledAttribute="True">
            <uc2:uBusinessPersonGroup ID="uBusinessPersonGroup" runat="server" />
        </dx:PopupControlContentControl>
    </ContentCollection>
</dx:ASPxPopupControl>
</asp:Content>
