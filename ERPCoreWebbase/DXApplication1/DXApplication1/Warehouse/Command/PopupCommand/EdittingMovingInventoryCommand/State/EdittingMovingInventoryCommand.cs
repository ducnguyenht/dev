...
{
    public class EdittingMovingInventoryCommand : NAS.GUI.Pattern.State
    {
        public EdittingMovingInventoryCommand(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        {
            getOwnerUIControl().CRUD_EdittingMovingInventoryCommand();
            return true;
        }

        public override bool UpdateGUI()
        {
            getOwnerUIControl().UpdateGUI_EdittingMovingInventoryCommand();
            return true;
        }
