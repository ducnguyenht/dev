<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Debit.aspx.cs" Inherits="WebModule.Purchasing.Debit" %>
...
<%@ Register Src="~/Accounting/UserControl/PaymentVoucherView.ascx" TagName="PaymentVoucherView" TagPrefix="uc2" %>
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <script type="text/javascript">
        ...
        function click_link_viewPaymentVoucher(s, e) {
            popup_showePaymentVoucher.Show();
        }
    </script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainHolder" runat="server">
    <div>
        ...
        <dx:ASPxGridView ID="gridview_master" KeyFieldName="customerid" runat="server" 
            ...
            <Columns>
                <dx:GridViewDataTextColumn Caption="Mã nhà cung cấp" FieldName="customerid" 
                    VisibleIndex="0">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Tên nhà cung cấp" FieldName="customername" 
                    VisibleIndex="1">
                    <FooterTemplate>
                        Tổng cộng:
                    </FooterTemplate>
                ...
                <dx:GridViewBandColumn Caption="Phát sinh" VisibleIndex="3">
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="Phát sinh có" FieldName="issue" 
                            VisibleIndex="0">
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                            <FooterTemplate>
                        ...
                        <dx:GridViewDataTextColumn Caption="Phát sinh nợ" FieldName="payment" 
                            VisibleIndex="1">
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                            <FooterTemplate>
            ...
            <Templates>
                <DetailRow>
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="Phát sinh nợ" FieldName="payment" 
                                ...
                                <DataItemTemplate>
                                    ...
                                    ClientSideEvents-Click="click_link_viewPaymentVoucher"/>
                                </DataItemTemplate>
                            </dx:GridViewDataTextColumn>
                        </Columns>
                    </dx:ASPxGridView>
                    <div style="float: right; margin-left: 4px">
                        ...
                        <Items>
                            <dx:LayoutItem Caption="Tổng phát sinh có" FieldName="form_bottom_E1" HorizontalAlign="Right">
                                <LayoutItemNestedControlCollection>
                            ...
                            <dx:LayoutItem Caption="Tổng phát sinh nợ" FieldName="form_bottom_E2" HorizontalAlign="Right">
                                <LayoutItemNestedControlCollection>
    ...
    <dx:aspxpopupcontrol id="popup_showePaymentVoucher" runat="server" clientinstancename="popup_showePaymentVoucher"
        ...
        <ContentCollection>
            <dx:PopupControlContentControl ID="PopupControlContentControl4" runat="server"   >
                <uc2:PaymentVoucherView ID="PaymentVoucherView1" runat="server" />
            </dx:PopupControlContentControl>
        </ContentCollection>
    </dx:aspxpopupcontrol>
</asp:Content>
