...
{
    public class SalesOrManufacturerExpense623Strategy : SalesOrManufacturerExpenseStrategy
    {
        private const string ACCOUNT_CODE = "623";

        public SalesOrManufacturerExpense623Strategy(Guid transactionId)
