...
{
    public class FinancialPrepaidExpense242Strategy : FinancialPrepaidExpenseStrategy
    {
        private const string ACCOUNT_CODE = "242";

        public FinancialPrepaidExpense242Strategy(Guid transactionId)
