<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="PayReceivingReport.aspx.cs" Inherits="WebModule.PayReceiving.Report.PayReceivingReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadHolder" runat="server">
    <script type="text/javascript">
        ...
        function OnGetValue(values) {
            ...
            popup_orderdetail.Show();
            popup_orderdetail.SetHeaderText(reportTitle);
            //viewer.Refresh();
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainHolder" runat="server">
    ...
    <dx:ASPxLabel ID="lblHeader" runat="server" Text="Danh sách sổ nhật ký chung" Font-Bold="True"
