...
{
    public class RuleConditionItemUnitSelectUnselectAll : NAS.GUI.Pattern.State
    {
        public RuleConditionItemUnitSelectUnselectAll(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
