...
{
    public class EdittingInputInventoryCommand : NAS.GUI.Pattern.State
    {
        public EdittingInputInventoryCommand(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        {
            getOwnerUIControl().CRUD_EdittingInputInventoryCommand();
            return true;
        }

        public override bool UpdateGUI()
        {
            getOwnerUIControl().UpdateGUI_EdittingInputInventoryCommand();
            return true;
        }
