...
{
    public partial class DiaryCurrency : System.Web.UI.Page, WebModule.Interfaces.IERPCoreWebModuleBase
    {
        public string AccessObjectId
        {
            get
            {
                return Constant.ACCESSOBJECT_PAYRECEIVE_DIARYCURRENCY_ID;
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            gvData.DataSource = ReportMappingConstant.getCurrencyDS();
            gvData.DataBind();
