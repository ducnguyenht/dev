<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InventoryVoucherEdit.ascx.cs" Inherits="ERPCore.Accounting.UserControl.InventoryVoucherEdit" %>
<%@ Register src="uInventoryVoucher_ex.ascx" tagname="uInventoryVoucher_ex" tagprefix="uc1" %>
<dx:ASPxTextBox ID="ASPxTextBox1" runat="server" Font-Bold="True" 
    Font-Size="Medium" Height="55px" Text="Danh sách phiếu xuất kho" 
    Width="259px">
        ...
        <dx:LayoutItem ShowCaption="False">
            <LayoutItemNestedControlCollection>
                <dx:LayoutItemNestedControlContainer runat="server" 
                    ...
                    <dx:ASPxButton ID="bt_approve_3" runat="server" CssClass="float-right button-right-margin" 
                        Text="Duyệt">
...
<uc1:uInventoryVoucher_ex ID="uInventoryVoucher_ex1" runat="server" />
