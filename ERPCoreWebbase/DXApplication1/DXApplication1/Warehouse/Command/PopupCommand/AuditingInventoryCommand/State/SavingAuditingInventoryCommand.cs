...
{
    public class SavingAuditingInventoryCommand : NAS.GUI.Pattern.State
    {
        public SavingAuditingInventoryCommand(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        public override bool Transit(NAS.GUI.Pattern.Context context, string transition, System.Web.UI.Control _UIControl)
        {
            switch (transition)
            {
                ...
                case "Delete":
                    ...
                    break;
                case "BookEntries":
                    //context.State = new BookingEntriesAuditingInventoryCommand(_UIControl);
                    break;
                default:
        ...
        {
            //getOwnerUIControl().CRUD_SavingAuditingInventoryCommand();
            return true;
        }
