...
{
    public class CodeRuleDefinifionEditingNumberData : NAS.GUI.Pattern.State
    {

        public CodeRuleDefinifionEditingNumberData(System.Web.UI.Control _UIControl) : base(_UIControl) { }
        ...
        {
            return getOwnerUIControl().CodeRuleDefinifionEditingNumberData_CRUD();
        }

        public override bool PreTransitionCRUD(string transition)
        {
            return getOwnerUIControl().CodeRuleDefinifionEditingNumberData_PreTransitionCRUD(transition);
        }

        public override bool UpdateGUI()
        {
            return getOwnerUIControl().CodeRuleDefinifionEditingNumberData_UpdateGUI();
        }
