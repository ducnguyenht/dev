...
namespace DXApplication1.ImExporting.UserControl
{
    public partial class uBuyingService : System.Web.UI.UserControl
    {
        ...
        protected void cpLineService_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
        ...
        protected void cboManufacturerService_ItemsRequestedByFilterCondition(object source, DevExpress.Web.ASPxEditors.ListEditItemsRequestedByFilterConditionEventArgs e)
        {
        ...
        protected void cboManufacturerService_ItemRequestedByValue(object source, DevExpress.Web.ASPxEditors.ListEditItemRequestedByValueEventArgs e)
        {
            if (e.Value == null)
            {
                return;
        ...
        protected void txtNameService_Validation(object sender, DevExpress.Web.ASPxEditors.ValidationEventArgs e)
        {
