...
{
    public class SalesOrManufacturerExpense622Strategy : SalesOrManufacturerExpenseStrategy
    {
        private const string ACCOUNT_CODE = "622";

        public SalesOrManufacturerExpense622Strategy(Guid transactionId)
