...
{
    public class FinancialItemInventory153Strategy: FinancialItemInventoryBase
    {
        private const string ACCOUNT_CODE = "153";

        public FinancialItemInventory153Strategy(Guid transactionId)
