...
{
    public class SalesOrManufacturerExpense154Strategy : SalesOrManufacturerExpenseStrategy
    {
        private const string ACCOUNT_CODE = "154";

        public SalesOrManufacturerExpense154Strategy(Guid transactionId)
