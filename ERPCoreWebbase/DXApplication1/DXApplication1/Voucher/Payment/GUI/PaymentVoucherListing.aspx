<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="PaymentVoucherListing.aspx.cs"
    Inherits="WebModule.Voucher.Payment.GUI.PaymentVoucherListing" %>

<%@ Register Src="PaymentVoucherEditingForm.ascx" TagName="PaymentVoucherEditingForm"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainHolder" runat="server">
    <div style="padding: 10px">
        <dx:ASPxLabel ID="ASPxLabel1" runat="server" Font-Bold="True" Font-Names="Segoe UI"
            Font-Size="Large" Text="Phiếu chi">
        </dx:ASPxLabel>
    </div>
    <div>
        ...
        <dx:XpoDataSource ID="dsReceiptVoucher" runat="server" TypeName="NAS.DAL.Vouches.PaymentVouches"
        ...
        <dx:ASPxGridView ID="gridviewReceiptVoucher" KeyboardSupport="True" runat="server"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Người nhận tiền" FieldName="Payee" VisibleIndex="6"
                    Width="10%">
                </dx:GridViewDataTextColumn>
        ...
        <uc1:PaymentVoucherEditingForm ID="PaymentVoucherEditingForm1" runat="server" />
    </div>
</asp:Content>
