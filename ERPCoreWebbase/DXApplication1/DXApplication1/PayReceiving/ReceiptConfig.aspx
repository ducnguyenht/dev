<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="ReceiptConfig.aspx.cs" Inherits="ERPCore.PayReceiving.ReceiptConfig" %>
<%@ Register src="UserControl/ReceiptConfigEdit.ascx" tagname="ReceiptConfigEdit" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadHolder" runat="server">
<script type="text/javascript">
    function grdData_EndCallback(s, e) {
        formReceiptConfigEdit.Show();
    }
</script>
...
<div style="margin-bottom:10px;">
    <dx:ASPxLabel ID="lblHeader" runat="server" Text="Cấu Hình Phân Loại Thu" 
...
<dx:ASPxCallbackPanel ID="cpHeader" runat="server" Width="100%" 
    ...
    <PanelCollection>
        <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">                        
            <dx:ASPxGridView ID="grdData" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    <dx:GridViewDataTextColumn Caption="Tên Phân Loại" FieldName="Name" Name="Name" 
                    ...
                    <dx:GridViewDataTextColumn Caption="Mã Phân Loại" FieldName="Code" Name="Code" 
    ...
    <uc1:ReceiptConfigEdit ID="ReceiptConfigEdit1" runat="server" />
</asp:Content>
