...
{
    public class PurchaseCreating : NAS.GUI.Pattern.State
    {
        public PurchaseCreating(System.Web.UI.Control _UIControl, bool o) : base(_UIControl, o) { }        
        public PurchaseCreating(System.Web.UI.Control _UIControl) : base(_UIControl) { }
        ...
        {
            return getOwnerUIControl().PurchaseCreating_UpdateGUI();
        }
