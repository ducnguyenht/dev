...
{
    public class OrderListEditing : NAS.GUI.Pattern.State
    {
        public OrderListEditing(System.Web.UI.Control _UIControl, bool o):  base(_UIControl, o) {}

        public OrderListEditing(System.Web.UI.Control _UIControl) : base(_UIControl) { }
        ...
        {
            return getOwnerUIControl().OrderListEditing_UpdateGUI();
        }
