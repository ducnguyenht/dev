<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentVoucherEdit.ascx.cs" Inherits="WebModule.Accounting.UserControl.PaymentVoucherEdit" %>
<style type="text/css">
    .style1
    {
        width: 100%;
...
<dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
    <dx:ASPxPopupControl ID="formPaymentVoucherEdit" runat="server" 
        HeaderText="Chi Tiết Phiếu Chi" Height="541px" RenderMode="Lightweight" 
        Width="784px" ClientInstanceName="formPaymentVoucherEdit" 
