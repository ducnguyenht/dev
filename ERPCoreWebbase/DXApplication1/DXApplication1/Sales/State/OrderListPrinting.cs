...
{
    public class OrderListPrinting : NAS.GUI.Pattern.State
    {
        
        public OrderListPrinting(System.Web.UI.Control _UIControl, bool o):  base(_UIControl, o) {}

        public OrderListPrinting(System.Web.UI.Control _UIControl) : base(_UIControl) { }
        ...
        {
            return getOwnerUIControl().OrderListPrinting_UpdateGUI();
        }
