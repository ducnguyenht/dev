<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="GrossSplitSale.aspx.cs" Inherits="WebModule.Accounting.GrossSplitSale" %>
...
<%--<%@ Register src="UserControl/uDeclareBillingVoucher.ascx" tagname="uDeclareBillingVoucher" tagprefix="uc2" %>--%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainHolder" runat="server">
    <div style="margin-bottom: 10px;">
        <dx:ASPxLabel ID="lblHeader" runat="server" Text="Gộp tách chứng từ bán hàng" Font-Bold="True"
            Font-Size="Small">
        </dx:ASPxLabel>
    </div>
    <div style="margin-bottom: 10px;">
        <dx:ASPxPageControl ID="pc" ClientInstanceName="pc" runat="server" ActiveTabIndex="0"
            ...
            OnActiveTabChanged="pc_ActiveTabChanged">
            <TabPages>
                    ...
                    <ContentCollection>
                        <dx:ContentControl ID="ContentControl1" runat="server" SupportsDisabledAttribute="True">
                            <div style="overflow: auto; height: 450px">
                                <div style="margin-bottom: 10px;">
                                    <dx:ASPxLabel ID="lblHeader1" runat="server" Text="Danh sách chứng từ bán hàng" Font-Bold="True"
                                        Font-Size="Small">
                                    </dx:ASPxLabel>
                                </div>
	...
	var key = s.GetRowKey(e.visibleIndex);
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Khách hàng" FieldName="supplier" ShowInCustomizationForm="True"
                                            VisibleIndex="4">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Ngày bán hàng" FieldName="date" ShowInCustomizationForm="True"
                                            VisibleIndex="3">
                                        </dx:GridViewDataTextColumn>
                                    </Columns>
	...
	var key = s.GetRowKey(e.visibleIndex);
                                                ...
                                                <Columns>
                                                    <dx:GridViewDataTextColumn Caption="Khách hàng" ShowInCustomizationForm="True" VisibleIndex="2"
                                                        FieldName="supplier">
                                                    </dx:GridViewDataTextColumn>
	...
	var key = s.GetRowKey(e.visibleIndex);
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Ngày bán" FieldName="date" ShowInCustomizationForm="True"
                                            VisibleIndex="3">
                                        </dx:GridViewDataTextColumn>
                                    </Columns>
                                    <Settings ShowFilterRow="True"></Settings>
                    ...
                    <ContentCollection>
                        <dx:ContentControl ID="ContentControl4" runat="server" SupportsDisabledAttribute="True">
                            <div style="overflow: auto; height: 450px">
                                    ...
                                    <Items>
                                        <dx:LayoutGroup Caption="Layout Group" ColCount="2" GroupBoxDecoration="None">
                                            <Items>
                                                ...
                                                <dx:LayoutItem Caption="Nhân viên bán hàng">
                                                    <LayoutItemNestedControlCollection>
                                ...
                                <br />
                                <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="2" Height="300px"
                                        ...
                                        <dx:TabPage Text="Chi tiết">
                                            <ContentCollection>
                                                <dx:ContentControl ID="ContentControl8" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxHtmlEditor ID="ASPxHtmlEditor1" runat="server" Width="100%" ActiveView="Preview">
                                                    </dx:ASPxHtmlEditor>
                                                </dx:ContentControl>
                                            </ContentCollection>
                                        </dx:TabPage>
                            ...
                            <div style="overflow: auto; height: 450px">
                                                ...
                                                <dx:LayoutItem Caption="Khách hàng">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer17" runat="server"
                                                            SupportsDisabledAttribute="True">
                                                            <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="Khách hàng 1">
                                                            </dx:ASPxLabel>
                                                        </dx:LayoutItemNestedControlContainer>
                                                    </LayoutItemNestedControlCollection>
                                                </dx:LayoutItem>
                                                ...
                                                <dx:LayoutItem Caption="Nhân viên bán hàng">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer19" runat="server"
                                                            SupportsDisabledAttribute="True">
                                                            <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text="Nhân viên A">
                                                            </dx:ASPxLabel>
                                                        </dx:LayoutItemNestedControlContainer>
                                                    </LayoutItemNestedControlCollection>
                                                </dx:LayoutItem>
                                                <dx:LayoutItem Caption="Nhân viên duyệt giá">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                                            <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text="Nhân viên B">
                                                            </dx:ASPxLabel>
                                                        </dx:LayoutItemNestedControlContainer>
                                                    </LayoutItemNestedControlCollection>
                                                </dx:LayoutItem>
                                                                    ...
                                                                    <dx:LayoutItem Caption="Tiền thuế GTGT">
                                                                        <LayoutItemNestedControlCollection>
                                                                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer21" runat="server"
                                                                                SupportsDisabledAttribute="True">
                                                                                <dx:ASPxSpinEdit ID="ASPxSpinEdit5" runat="server" Height="21px" Number="0">
                                                                                </dx:ASPxSpinEdit>
                                                                            </dx:LayoutItemNestedControlContainer>
                                                                        </LayoutItemNestedControlCollection>
                                                                    </dx:LayoutItem>
                                                                    ...
                                                                    <dx:LayoutItem Caption="Tổng tiền hàng hóa">
                                                                        <LayoutItemNestedControlCollection>
                                                                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer23" runat="server"
                                                                                SupportsDisabledAttribute="True">
                                                                                <dx:ASPxSpinEdit ID="ASPxSpinEdit7" runat="server" Height="21px" Number="0">
                                                                                </dx:ASPxSpinEdit>
                                                                            </dx:LayoutItemNestedControlContainer>
                                                                        </LayoutItemNestedControlCollection>
                                                                    </dx:LayoutItem>
                                                        ...
                                                        <Items>
                                                            <dx:LayoutGroup Caption="Layout Item" ColCount="2" GroupBoxDecoration="None">
                                                                <Items>
                                                                    <dx:LayoutItem Caption="Thuế suất GTGT">
                                                                        <LayoutItemNestedControlCollection>
                                                                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer24" runat="server"
                                                                                SupportsDisabledAttribute="True">
                                                                                <dx:ASPxSpinEdit ID="ASPxSpinEdit8" runat="server" Height="21px" Number="0">
                                                                                </dx:ASPxSpinEdit>
                                                                            </dx:LayoutItemNestedControlContainer>
                                                                        </LayoutItemNestedControlCollection>
                                                                    </dx:LayoutItem>
                                                                    <dx:LayoutItem Caption="Tiền thuế GTGT">
                                                                        <LayoutItemNestedControlCollection>
                                                                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer121" runat="server"
                                                                                SupportsDisabledAttribute="True">
                                                                                <dx:ASPxSpinEdit ID="ASPxSpinEdit9" runat="server" Height="21px" Number="0">
                                                                                </dx:ASPxSpinEdit>
                                                                            </dx:LayoutItemNestedControlContainer>
                                                                        </LayoutItemNestedControlCollection>
                                                                    </dx:LayoutItem>
                                                                    ...
                                                                    <dx:LayoutItem Caption="Tổng tiền dịch vụ">
                                                                        <LayoutItemNestedControlCollection>
                                                                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer26" runat="server"
                                                                                SupportsDisabledAttribute="True">
                                                                                <dx:ASPxSpinEdit ID="ASPxSpinEdit10" runat="server" Height="21px" Number="0">
                                                                                </dx:ASPxSpinEdit>
                                                                            </dx:LayoutItemNestedControlContainer>
                                                                        </LayoutItemNestedControlCollection>
                                                                    </dx:LayoutItem>
                                            ...
                                            <ContentCollection>
                                                <dx:ContentControl ID="ContentControl11" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ContentControl ID="ContentControl13" runat="server" SupportsDisabledAttribute="True">
                                                        <%--<dx:ASPxCheckBox ID="ASPxCheckBox2" runat="server" CheckState="Checked" Text="Chiết Khấu"
                                                            ClientInstanceName="cbchietkhau" Checked="True">
                                                            <ClientSideEvents CheckedChanged="checkboxchietkhau_invi" />
                                                            <ClientSideEvents CheckedChanged="checkboxchietkhau_invi"></ClientSideEvents>
                                                        </dx:ASPxCheckBox>--%>
                                                        ...
                                                        <%--<dx:ASPxCheckBox ID="ASPxCheckBox3" runat="server" CheckState="Checked" Text="Tiền Giảm"
                                                            ClientInstanceName="cbtiengiam" Checked="True">
                                                            <ClientSideEvents CheckedChanged="checkboxtiengiam_invi" />
                                                            <ClientSideEvents CheckedChanged="checkboxtiengiam_invi"></ClientSideEvents>
                                                        </dx:ASPxCheckBox>--%>
                                                        ...
                                                        <%--<dx:ASPxCheckBox ID="ASPxCheckBox4" runat="server" CheckState="Checked" Text="Quà Tặng"
                                                            ClientInstanceName="cbquatang" Checked="True">
                                                            <ClientSideEvents CheckedChanged="checkboxquatang_invi" />
                                                            <ClientSideEvents CheckedChanged="checkboxquatang_invi"></ClientSideEvents>
                                                        </dx:ASPxCheckBox>--%>
                                        ...
                                        <dx:LayoutItem Caption="Tổng giá trị phiếu bán hàng">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer27" runat="server"
                                                    SupportsDisabledAttribute="True">
                                                    <dx:ASPxSpinEdit ID="ASPxSpinEdit12" runat="server" Height="21px" Number="0">
                                                    </dx:ASPxSpinEdit>
                                                </dx:LayoutItemNestedControlContainer>
                                            </LayoutItemNestedControlCollection>
                                        </dx:LayoutItem>
                                        <dx:LayoutItem ColSpan="2" Caption="Chú thích">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer28" runat="server"
                                                    SupportsDisabledAttribute="True">
                                                    <dx:ASPxTextBox ID="ASPxTXTChuThich1" runat="server" Width="100%">
                                                    </dx:ASPxTextBox>
                                                </dx:LayoutItemNestedControlContainer>
                                            </LayoutItemNestedControlCollection>
                                        </dx:LayoutItem>
                                ...
                                <div style="margin-top: 10px">
                                    <%--<div class="float-right" style="margin-left: 4px">
                                        <dx:ASPxButton ID="ASPxButton7" runat="server" AutoPostBack="False" ClientInstanceName="buttonContinue"
                                            Text="Tiếp tục">
                                            <Image>
                                                <SpriteProperties CssClass="Sprite_ReAct" />
                                                <SpriteProperties CssClass="Sprite_ReAct"></SpriteProperties>
                                            </Image>
                                        </dx:ASPxButton>
                                    </div>--%>
                                    <div class="float-right" style="margin-left: 4px">
                                        <dx:ASPxButton ID="buttonOrderPrint" runat="server" ClientInstanceName="buttonOrderPrint"
                                            Text="In hóa đơn" AutoPostBack="false">
                                            <Image>
    ...
    <%--<dx:ASPxPopupControl ID="popup_declareTax" runat="server" ClientInstanceName="popup_declareTax"
        ...
        <ContentCollection>
            <dx:PopupControlContentControl>
                <uc2:uDeclareBillingVoucher ID="uDeclareBillingVoucher1" runat="server" />
            </dx:PopupControlContentControl>
        </ContentCollection>
