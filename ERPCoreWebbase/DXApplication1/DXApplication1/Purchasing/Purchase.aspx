<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Purchase.aspx.cs" Inherits="ERPCore.Purchasing.Purchase" %>

<%@ Register src="UserControl/ToolBar.ascx" tagname="ToolBar" tagprefix="uc3" %><%@ Register src="UserControl/uPurchaseEdit.ascx" tagname="uPurchaseEdit" tagprefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function handleEvent(event) {
            alert('Hello! This is the new event');
        };

        target.addListener("refreshInventory", handleEvent);
        //        target.fire({ type: "refreshInventory" });
...
//                });
        ...
        function grdPurchaseEditProduct_EndCallback(s, e) {
            if (s.cpSumProductItem) {           
                cpLine.PerformCallback('sumProductItem');
...
//        }
        ...
        function grdPurchaseEditService_EndCallback(s, e) {
            if (s.cpSumServiceItem) {
                cpLine.PerformCallback('sumServiceItem');
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainHolder" runat="server">    
    <div style="margin-bottom: 10px;">       
        <dx:aspxlabel id="lblHeader" runat="server" text="Phiếu Mua Hàng" font-bold="True"
            font-size="Small">
        </dx:aspxlabel>        
    </div>
                ...
                <PanelCollection>
                    <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                        <dx:XpoDataSource ID="PurchaseReceiptXDS" runat="server" DefaultSorting="" 
                            TypeName="NAS.DAL.Invoice.PurchaseInvoice" ServerMode="True" Criteria="">
                        </dx:XpoDataSource>
