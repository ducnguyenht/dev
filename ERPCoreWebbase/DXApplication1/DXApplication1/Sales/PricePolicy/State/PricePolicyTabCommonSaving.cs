...
{
    public class PricePolicyTabCommonSaving : NAS.GUI.Pattern.State
    {
        public PricePolicyTabCommonSaving(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        {
            getOwnerUIControl().CRUD_TabCommonInfoSaving();
            return true;
        }
        ...
        public override bool UpdateGUI()
        {
            ...
            usrc.UpdateGUI_ClickTabCommonEditting();
            return true;
        }
