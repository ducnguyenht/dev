<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="LiabiPartners.aspx.cs"
    Inherits="DXApplication1.GUI.LiabiPartners" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainHolder" runat="server">
    <div>
        ...
        <dx:ASPxGridView ID="gridview_master" KeyFieldName="customerid" runat="server" 
            ...
            <Columns>
                <dx:GridViewDataTextColumn Caption="Mã đối tác" FieldName="customerid" 
                    VisibleIndex="0">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Tên đối tác" FieldName="customername" 
                    VisibleIndex="1">
                    <FooterTemplate>
                        Tổng cộng:
                    </FooterTemplate>
                ...
                <ContentCollection>
                    <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server" SupportsDisabledAttribute="True">
                        ...
                        <dx:ReportViewer ID="ReportViewer1" runat="server" 
                            Report="<%# new DXApplication1.GUI.Sales.Report.MauSo01_BH() %>" 
                            ReportName="DXApplication1.GUI.Sales.Report.MauSo01_BH">
                        </dx:ReportViewer>
                        <br />
