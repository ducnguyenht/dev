...
{
    public class NASCustomFieldTypeDepartmentBuiltInMultiSelectionListStrategyCreator
        : NASCustomFieldTypeBuiltInMultiSelectionListStrategyCreator
    {
        ...
        {
            return new NASCustomFieldTypeDepartmentBuiltInMultiSelectionListStrategy();
        }
    }
}