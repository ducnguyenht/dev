...
{
    public class SalesOrManufacturerExpense621Strategy : SalesOrManufacturerExpenseStrategy
    {
        private const string ACCOUNT_CODE = "621";

        public SalesOrManufacturerExpense621Strategy(Guid transactionId)
