...
{
    public class LegalInvoiceArtifact_Creating : NAS.GUI.Pattern.State
    {
        public LegalInvoiceArtifact_Creating(System.Web.UI.Control _UIControl) : base(_UIControl) { }
        ...
        {
            getOwnerUIControl().CRUD_LegalInvoiceArtifact_Creating();
            return true;
        }

        public override bool UpdateGUI()
        {
            getOwnerUIControl().UpdateGUI_LegalInvoiceArtifact_Creating();
            return true;
        }
