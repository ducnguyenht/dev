...
{
    public class CreatingMovingInventoryCommand: NAS.GUI.Pattern.State
    {
        public CreatingMovingInventoryCommand(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        {
            getOwnerUIControl().CRUD_CreatingMovingInventoryCommand();
            return true;
        }

        public override bool UpdateGUI()
        {
            getOwnerUIControl().UpdateGUI_CreatingMovingInventoryCommand();
            return true;
        }
