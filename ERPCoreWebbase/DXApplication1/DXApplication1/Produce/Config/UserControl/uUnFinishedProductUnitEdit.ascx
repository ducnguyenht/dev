<%@ Control Language="C#" AutoEventWireup="true" ClientIDMode="AutoID" CodeBehind="uUnFinishedProductUnitEdit.ascx.cs"
    Inherits="WebModule.Produce.Config.UserControl.uUnFinishedProductUnitEdit" %>
<style type="text/css">
    .dxbButton_DevEx
    {
        color: #201f35;
...
<div id="lineContainerUnFinishedProductUnit">
    <dx:ASPxCallbackPanel ID="cbpanelUserUnFinishedProductUnit" runat="server" Width="850px"
        ClientInstanceName="cbpanelUserUnFinishedProductUnit" OnCallback="cbpanelUserUnFinishedProductUnit_Callback">
        <PanelCollection>
            <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                <dx:ASPxPopupControl ID="formUnFinishedProductUnitEdit" runat="server" HeaderText="Thông Tin Đơn Vị Tính - "
                    Height="600px" Modal="True" Width="900px" ClientInstanceName="formUnFinishedProductUnitEdit"
                                    ...
                                    <dx:TabPage Text="Thông Tin Chung">
                                        <ContentCollection>
                                            <dx:ContentControl ID="ContentControl1" runat="server" SupportsDisabledAttribute="True">
                                                <dx:ASPxFormLayout ID="ASssdFo2r11mLayout1" runat="server" AlignItemCaptionsInAllGroups="True"
