...
{
    public class NASCustomFieldTypeOrganizationBuiltInMultiSelectionListStrategyCreator
        : NASCustomFieldTypeBuiltInMultiSelectionListStrategyCreator
    {
        ...
        {
            return new NASCustomFieldTypeOrganizationBuiltInMultiSelectionListStrategy();
        }
    }
}