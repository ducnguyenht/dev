...
namespace MVC.Areas.Sell.Models
{
    ...
    public class APIMTOrderItemList
    {
        public List<APIMTOrderItem> GetData()
        {
            string key = "403FC600-3BD2-41AD-AD56-56FA68C0D831";
            if (HttpContext.Current.Session[key] == null)
            {
                List<APIMTOrderItem> Sale = new List<APIMTOrderItem>();
                Sale.Add(
                    new APIMTOrderItem()
                    {
                        NO = 1,
            ...
            return (List<APIMTOrderItem>)HttpContext.Current.Session[key];
        }
        public void AddItem(APIMTOrderItem postedItem)
        {
            List<APIMTOrderItem> list = GetData();
            postedItem.Code = (list.Count + 1);
            list.Add(postedItem);
        }


        public void UpdateItem(APIMTOrderItem postedItem)
        {
