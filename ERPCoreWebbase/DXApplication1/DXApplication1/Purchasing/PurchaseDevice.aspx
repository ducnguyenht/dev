<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="PurchaseDevice.aspx.cs" Inherits="WebModule.Purchasing.PurchaseDevice" %>
<%@ Register Src="UserControl/uPurchaseDeviceEdit.ascx" TagName="uPurchaseDeviceEdit" TagPrefix="uc1" %>
...
<div style="margin-bottom: 10px;">
    <dx:ASPxLabel ID="lblHeader" runat="server" Text="Phiếu Mua Công Cụ Dụng Cụ" Font-Bold="True"
        Font-Size="Small">
    </dx:ASPxLabel>
</div>
...
<tr>
    <td>
         <uc1:uPurchaseDeviceEdit ID="uPurchaseDeviceEdit1" runat="server" />
    </td>
</tr>
<tr>
    <td>               
