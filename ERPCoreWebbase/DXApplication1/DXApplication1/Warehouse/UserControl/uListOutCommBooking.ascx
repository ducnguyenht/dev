<%@ Control Language="C#" AutoEventWireup="true" ClientIDMode="AutoID" CodeBehind="uListOutCommBooking.ascx.cs"
    Inherits="ERPCore.Warehouse.UserControl.uListOutCommBooking" %>
<style type = "text/css">
    .float-right
    {
        float:right;
        ...
        <dx:ASPxCallbackPanel ID="cpBookingCommand" runat="server" 
            ...
            <PanelCollection>
                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                    ...
                    <dx:ASPxButton ID="buttonBookingPrint" runat="server" AutoPostBack="False" 
                        ClientInstanceName="buttonBookingPrint" 
                        CssClass="float-right button-right-margin" Text="In Phiếu" 
                        UseSubmitBehavior="False" Wrap="False">
                        <ClientSideEvents Click="buttonBookingPrint_Click" />
                        <Image>
                    ...
                    <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                        <dx:ASPxGridView ID="grdBooking" runat="server" AutoGenerateColumns="False" ClientInstanceName="grdBooking"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="SalesInvoiceInventoryTransactionId!Key" ReadOnly="True" 
                                    ShowInCustomizationForm="True" VisibleIndex="1" Width="0px">
                                    <PropertiesTextEdit EnableFocusedStyle="False">
                                    </PropertiesTextEdit>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Mã phiếu xuất kho" ShowInCustomizationForm="True"
                                    VisibleIndex="6" Width="150px" FieldName="SalesInvoiceInventoryTransactionId.Code" 
                                    ReadOnly="True">
                                </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:ASPxGridView ID="grdBookingDetail" runat="server" 
                                        ...
                                        <Columns>
                                            <dx:GridViewDataComboBoxColumn Caption="Tài khoản" FieldName="AccountId!Key" 
                                                ...
                                                <PropertiesComboBox ValueField="AccountId" 
                                                    ValueType="System.Guid" EnableCallbackMode="true" 
                                                    IncrementalFilteringMode="Contains" TextField="Code" CallbackPageSize="10" 
                                                    TextFormatString="{0} - {1}" DropDownStyle="DropDown">
                                                    <Columns>
...
<dx:XpoDataSource runat="server" TypeName="NAS.DAL.Accounting.Journal.GeneralJournal"
    ...
    Criteria="[TransactionId] = ? And [RowStatus] &gt; 0">
    <CriteriaParameters>
...
<dx:XpoDataSource ID="InventoryTransactionXDS" runat="server" 
    TypeName="NAS.DAL.Accounting.Journal.SalesInvoiceInventoryAccountingTransaction" 
    Criteria="[SalesInvoiceInventoryTransactionId] = ?">
    <CriteriaParameters>
