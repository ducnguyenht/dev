...
{
    public class FinancialCustomerLiabilityJob : IETLJob
    {
        private string fJobRegisterCode;
        public string JobRegisterCode
        {
            get { return "FinancialCustomerLiability"; }
        }

        private int fBusinessObjectTypeId;
        public List<int> BusinessObjectTypeId
        {
            get { return new List<int> { Constant.BusinessObjectType_Transaction,
        ...
        List<ETL_FinnancialCustomerLiabilityDetail> detailList = new List<ETL_FinnancialCustomerLiabilityDetail>();
        private bool fStop;
        public bool Stop
        {
            get { return fStop; }
        ...
        public void Extract()
        {
            ...
            XPCollection<BusinessObject> oldbusinessObjects = _BusinessObjectBO.GetAllBussinessObjectsAfterSpecificTransaction(
                ...
                RefId);     
            transaction = accountingBO.ExtractTransaction(session, RefId, "131");
        ...
        public void Transform()
        {
            ...
            detailList = liabilityBO.TransformTransactionToCustomerLiabilityDetail(session, transaction, "131");
            #region test Duc.Vo
            #endregion
        }
        ...
        public void Load()
        {
            ...
            if (RefId != Guid.Empty)
            {
                liabilityBO.LoadFinancialCustomerLiabilityDetail(session, detailList, "131");
