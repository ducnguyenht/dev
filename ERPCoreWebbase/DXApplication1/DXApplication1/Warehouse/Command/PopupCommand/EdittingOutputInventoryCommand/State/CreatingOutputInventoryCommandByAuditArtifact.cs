...
{
    public class CreatingOutputInventoryCommandByAuditArtifact : NAS.GUI.Pattern.State
    {
        public CreatingOutputInventoryCommandByAuditArtifact(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        {
            getOwnerUIControl().CRUD_CreatingOutputInventoryCommandByAuditArtifact();
            return true;
        }

        public override bool UpdateGUI()
        {
            getOwnerUIControl().UpdateGUI_CreatingOutputInventoryCommandByArtifact();
            return true;
        }
