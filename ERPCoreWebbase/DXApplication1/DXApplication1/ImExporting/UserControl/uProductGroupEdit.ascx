<%@ Control Language="C#" AutoEventWireup="true" ClientIDMode="AutoID" CodeBehind="uProductGroupEdit.ascx.cs"
    Inherits="ERPCore.ImExporting.UserControl.uProductGroupEdit" %>
<style type="text/css">
    .dxbButton_DevEx
    {
        color: #201f35;
...
<div id="lineContainerProductGroup">
    <dx:ASPxCallbackPanel ID="cpLineProductGroup" runat="server" Width="100%" ClientInstanceName="cpLineProductGroup"
        OnCallback="cpLineProductGroup_Callback">
        <ClientSideEvents EndCallback="cpLineProductGroup_EndCallback" />
<ClientSideEvents EndCallback="cpLineProductGroup_EndCallback"></ClientSideEvents>
        <PanelCollection>
                                        ...
                                        <ContentCollection>
											...
											<Items>
												<dx:LayoutItem HorizontalAlign="Right" ShowCaption="False">
												 ...
												 <dx:ASPxNavBar ID="ASPxNavBar12" runat="server" AutoCollapse="True" Height="100%"
                                                    Width="100%">
                                                    <Groups>
