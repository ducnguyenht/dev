...
namespace WebModule.Invoice.SalesInvoice.Control.DeliverySchedule
{
    public partial class ucDeliverySchedule : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (url.Contains("Invoice/SalesInvoice/GUI/MaterialSalesInvoiceListingForm.aspx"))
            {
            ...
            else if (url.Contains("Invoice/SalesInvoice/GUI/FixedAssetsSalesInvoiceListingForm.aspx"))
            {
        ...
        protected void GridDeliveryPlanning_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            ...
            GridDeliveryPlanning.CancelEdit();
            InventoryTransactionBO saleInvoiceTransactionBO = new InventoryTransactionBO();
            saleInvoiceTransactionBO.UpdateInventoryTransaction(session, Guid.Parse(e.Keys["InventoryTransactionId"].ToString()), (DateTime)e.NewValues["IssueDate"], (string)e.NewValues["Code"], (string)e.NewValues["Description"]);
            GridDeliveryPlanning.DataSource = saleInvoiceTransactionBO.GetDeliveryPlanningForBill<NAS.DAL.Invoice.SalesInvoice>(session, BillId);
            GridDeliveryPlanning.DataBind();
        }
