<%@ Control Language="C#" ClientIDMode="AutoID" AutoEventWireup="true" CodeBehind="uPaymentVoucherCosting.ascx.cs"
    Inherits="WebModule.Accounting.UserControl.uPaymentVoucherCosting" %>
<script type="text/javascript">
    var CostingEditForm = {
        ...
        Focus: function () {
            var jObject = $(".KeyShortcutpopCostingEditForm");
            jObject.focus();
        }
    };
...
<dx:ASPxPopupControl ID="popCosting" runat="server" CssClass="KeyShortcutpopCostingEditForm"
    AllowDragging="True" AllowResize="True" AppearAfter="200" ClientInstanceName="popCosting"
    HeaderText="Hạch toán" Height="600px" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter"
    Width="850px" ShowFooter="True" ShowMaximizeButton="True" Modal="True" OnWindowCallback="popCosting_WindowCallback"
    CloseAction="CloseButton" Maximized="True">
    <ClientSideEvents Closing="CostingEditForm.Closing" Init="popCosting_Init" CallbackError="popCosting_CallbackError"
        EndCallback="popCosting_EndCallback" Shown="popCosting_Shown" CloseButtonClick="popCosting_CloseButtonClick" />
    <ClientSideEvents Closing="CostingEditForm.Closing" Shown="popCosting_Shown" EndCallback="popCosting_EndCallback"
        CallbackError="popCosting_CallbackError" Init="popCosting_Init"></ClientSideEvents>
    <FooterTemplate>
        <div style="padding: 10px;">
            ...
            <div style="float: right">
                <div style="float: left;">
                    <!-- Places button here -->
                    <dx:ASPxButton ID="btnApproveCosting" ClientInstanceName="btnApproveCosting" AutoPostBack="false" runat="server" Text="Duyệt"
                        Wrap="False" OnLoad="btnApproveCosting_Load">
                        <Image>
            ...
            <dx:ASPxFormLayout ID="frmCosting" runat="server" DataSourceID="dsOriginArtifact"
                ...
                <Items>
                    <dx:LayoutGroup Caption="Thông tin chứng từ" ColCount="2">
                        <Items>
                            <dx:LayoutItem Caption="Mã phiếu chi" FieldName="Code" Width="50%">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxLabel ID="lblCode" runat="server" Font-Bold="True" Text="">
                                        </dx:ASPxLabel>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                            <dx:LayoutItem Caption="Phân loại" FieldName="VouchesTypeId.Description" Width="50%">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxLabel ID="lblVoucherType" runat="server" Text="">
                                        </dx:ASPxLabel>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                            <dx:LayoutItem Caption="Ngày chi" FieldName="IssuedDate">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                            ...
                            <dx:LayoutItem Caption="Đơn vị nhận" FieldName="SourceOrganizationId.Name">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                            ...
                            <dx:LayoutItem Caption="Lý do chi" FieldName="Description">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                            ...
                            <dx:LayoutItem Caption="Số tiền quy đổi">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server"
                                        ...
                                        <dx:ASPxLabel ID="lblSumOfCredit" runat="server" Font-Bold="True">
                                        </dx:ASPxLabel>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                            <dx:LayoutItem Caption="Người nhận tiền" FieldName="Payee">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxLabel ID="lblPayer" runat="server" Text="">
                                        </dx:ASPxLabel>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                    ...
                    <dx:TabbedLayoutGroup Width="100%">
                        <Items>
                            <dx:LayoutItem Caption="Thông tin định khoản">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxGridView ID="grdTransaction" ClientInstanceName="grdTransaction" runat="server"
                                            ...
                                            OnRowValidating="grdTransaction_RowValidating" OnCustomCallback="grdTransaction_CustomCallback"
                                            KeyboardSupport="True" OnCellEditorInitialize="grdTransaction_CellEditorInitialize"
                                            OnRowUpdated="grdTransaction_RowUpdated" 
                                            OnRowInserted="grdTransaction_RowInserted" 
                                            OnInitNewRow="grdTransaction_InitNewRow">
                                            <ClientSideEvents Init="grdTransaction_Init" EndCallback="function(s, e) {
	s.DetailRows.ExpandRow(0);
}"></ClientSideEvents>
                                            <Columns>
...
<RegularExpression ErrorText="Mã không đúng định dạng" ValidationExpression="<%$ Resources:Resources, validation_regex_code %>" />
                                                    ...
                                                    <HeaderCaptionTemplate>
                                                        <dx:ASPxImage ID="ASPxImage1" runat="server" ShowLoadingImage="true" SpriteCssClass="Sprite_Caption"
                                                            ToolTip="Tối đa 36 kí tự liền kề kh6ong dấu">
                                                        </dx:ASPxImage>
...
<RequiredField ErrorText="Chưa chọn ngày" IsRequired="True" />
                                            ...
                                            <Templates>
                                                <DetailRow>
                                                    <dx:ASPxGridView ID="grdGeneralJournal" ClientInstanceName="grdGeneralJournal" runat="server"
                                                        ...
                                                        OnLoad="grdGeneralJournal_Load" OnRowUpdating="grdGeneralJournal_RowUpdating"
                                                        ...
                                                        <Columns>
                                                            <dx:GridViewCommandColumn Name="CommonOperations" ButtonType="Image" Caption="Thao tác"
                                                                VisibleIndex="4">
                                                                <EditButton Visible="True">
                                                                    <Image ToolTip="Sửa">
                                                                        <SpriteProperties CssClass="Sprite_Edit" />
                                                            ...
                                                            <dx:GridViewDataComboBoxColumn Caption="Tài khoản" FieldName="AccountId!Key" VisibleIndex="1">
                                                                <PropertiesComboBox EnableCallbackMode="True" IncrementalFilteringMode="Contains"
                                                                    LoadDropDownOnDemand="True" ValueField="AccountId" ValueType="System.Guid"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="Diễn giải" FieldName="Description" VisibleIndex="0">
                                                            </dx:GridViewDataTextColumn>
                                                        </Columns>
                                                        <SettingsEditing Mode="Inline" />
                                        ...
                                        <dx:XpoDataSource ID="dsTransaction" runat="server" TypeName="NAS.DAL.Accounting.Journal.PaymentVouchesTransaction"
                                            Criteria="[PaymentVouchesId.VouchesId] = ?" DefaultSorting="">
                                            <CriteriaParameters>
            ...
            <dx:XpoDataSource ID="dsOriginArtifact" runat="server" TypeName="NAS.DAL.Vouches.PaymentVouches"
                Criteria="[VouchesId] = ?">
                <CriteriaParameters>
                    <asp:Parameter Name="VoucherId" />
                </CriteriaParameters>
