<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="ReportFinishedProduct.aspx.cs" Inherits="WebModule.Warehouse.ReportFinishedProduct" %>
...
<script type="text/javascript">
    ...
    function ShowPopup(productName) {
        ...
        pcReportViewerPopup.SetHeaderText("Báo cáo tồn thành phẩm: " + productName);
        reportType.Set('ReportType', "ReportFinish");
