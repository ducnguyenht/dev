<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uSplit_p.ascx.cs" Inherits="WebModule.PayReceiving.UserControl.uSplit_p" %>
<style type="text/css">
.float_right
{
    float:right;
    ...
    <PanelCollection>
        <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
            <dx:ASPxPopupControl ID="PopupSplit" runat="server" CloseAction="CloseButton" DragElement="Window"
                HeaderText="Tách phiếu chi" RenderMode="Lightweight" Width="650px" 
                AllowDragging="True" ClientInstanceName="popsplit_p" 
                ...
                <ContentCollection>
                    <dx:PopupControlContentControl runat="server" SupportsDisabledAttribute="True">
                        <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" ColCount="2" 
                            Width="100%">
                            <Items>
                                <dx:LayoutGroup Caption="Phiếu Chi Nguồn" ColCount="2" 
                                    GroupBoxDecoration="HeadingLine" ColSpan="2">
                                    <Items>
                                        <dx:LayoutItem Caption="Mã phiếu chi">
                                        ...
                                        <dx:LayoutItem Caption="Tổng tiền phiếu chi">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                ...
                                <dx:LayoutGroup Caption="Phiếu Chi Đích" GroupBoxDecoration="HeadingLine" 
                                    ColSpan="2">
                                    <Items>
                                            ...
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" Width="100%">
                                                        <Columns>
                                                            <dx:GridViewDataTextColumn Caption="Mã Phiếu Chi Đích" FieldName="Code" ShowInCustomizationForm="True"
                                                                VisibleIndex="0">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="Đối Tượng Nhận Tiền" FieldName="NN" ShowInCustomizationForm="True"
                                                                VisibleIndex="1">
                                                                <FooterTemplate>
