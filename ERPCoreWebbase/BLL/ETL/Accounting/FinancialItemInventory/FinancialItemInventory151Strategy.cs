...
{
    public class FinancialItemInventory151Strategy : FinancialItemInventoryBase
    {
        private const string ACCOUNT_CODE = "151";

        public FinancialItemInventory151Strategy(Guid transactionId)
