<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentOrderConfirmN.ascx.cs" Inherits="ERPCore.Accounting.UserControl.PaymentOrderConfirmN" %>
...
<dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
    <dx:ASPxPopupControl ID="formPaymentOrderConfirmN" runat="server" Width="600px" 
        ClientInstanceName="formPaymentOrderConfirmN" HeaderText="Xác nhận ủy nhiệm chi" 
