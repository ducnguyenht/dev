...
{
    public class ReceiptVoucherLocked : VoucherState
    {
        public ReceiptVoucherLocked(System.Web.UI.Control _UIControl)
            : base(_UIControl)
        { }
        ...
        {
            return getOwnerUIControl().ReceiptVoucherLocked_PreTransitionCRUD(transition);
        }

        public override bool CRUD()
        {
            return getOwnerUIControl().ReceiptVoucherLocked_CRUD();
        }

        public override bool UpdateGUI()
        {
            return getOwnerUIControl().ReceiptVoucherLocked_UpdateGUI();
        }
