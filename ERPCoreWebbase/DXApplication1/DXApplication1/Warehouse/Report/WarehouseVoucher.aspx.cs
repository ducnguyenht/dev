...
{
    public partial class WarehouseVoucher : System.Web.UI.Page, WebModule.Interfaces.IERPCoreWebModuleBase
    {
        public string AccessObjectId
        {
            get
            {
                return Constant.ACCESSOBJECT_WAREHOUSE_REPORT_ID;
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            gvData.DataSource = ReportMappingConstant.getWarehouseDS();
            gvData.DataBind();
