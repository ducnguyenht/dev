...
using WebModule.Purchasing.State;
using WebModule.Purchasing.Report;
...
namespace ERPCore.Purchasing.UserControl
{
    ...
    public partial class uPurchaseEdit : System.Web.UI.UserControl
    {
        ...
        public bool PurchaseLoading_UpdateGUI()
        {
            if (hPurchaseEditId.Contains("id"))
            {
                ...
                {                 
                    ...
                    PurchaseInvoiceBO salesInvoiceBO = new PurchaseInvoiceBO();
                    Guid billId = salesInvoiceBO.insertEmptyPurchaseInvoice(session);

                    Session["InventoryTransactionId"] = Guid.Empty;
                    ...
                    grdDeliveryScheduleActual.DataSource = null;
                ...
                else
                {
                    ...
                    PurchaseInvoice salesInvoice = uow.GetObjectByKey<PurchaseInvoice>(Guid.Parse(hPurchaseEditId.Get("id").ToString()));
                    ...
                    filter = new BinaryOperator("Code", "TAXTYPE_VAT_PRODUCT", BinaryOperatorType.Equal);                    

                    TaxType taxType = session.FindObject<TaxType>(filter);
                    ...
                    filter = new BinaryOperator("Code", "TAXTYPE_VAT_SERVICE", BinaryOperatorType.Equal);                    

                    taxType = session.FindObject<TaxType>(filter);
                    ...
                    string sql = "select SUM(gl.Debit) as paided " +
                                " from GeneralJournal gl, PurchaseInvoiceTransaction sit" +
                    ...
                    grdDeliveryScheduleActual.DataSource = list.ToList();
                    grdDeliveryScheduleActual.DataBind();

                   
                    XPQuery<SaleInvoiceTransaction> saleInvoiceTransactionF = new XPQuery<SaleInvoiceTransaction>(session);
                    XPQuery<GeneralJournal> generalJournal = new XPQuery<GeneralJournal>(session);

                    var list1 = from i in generalJournal.AsEnumerable()
                               join s in saleInvoiceTransactionF.AsEnumerable() on i.TransactionId.TransactionId equals s.TransactionId
                               where s.SalesInvoiceId.BillId == Guid.Parse(Session["SaleBillId"].ToString())
                               && i.JournalType == 'A' && i.Debit > 0                            
                               select new
                               {
                                   CreateDate = i.CreateDate,                                
                                   Debit = i.Debit,
                                   Code = i.TransactionId.Code,                                   
                                   Description = i.TransactionId.Description
                               };


                    grdPaymentScheduleActual.DataSource = list1.ToList();
        ...
        public bool PurchaseCreating_UpdateGUI()
        {
            if (!validate())
            {
            ...
            PurchaseInvoiceBO salesInvoiceBO = new PurchaseInvoiceBO();
            PurchaseInvoice salesInvoice = salesInvoiceBO.PurchaseInvoiceInit(session,
                                        Guid.Parse(Session["SaleBillId"].ToString()),
                                        "PO",
                                        txtCode.Text,
            ...
            salesInvoiceBO.updatePurchaseInvoice(session,
                                                    salesInvoice,                                                    
        ...
        public bool PurchaseEditing_UpdateGUI()
        {
            Status = "edit";
        ...
        public bool PurchaseExiting_UpdateGUI()
        {
            Status = "exit";
            return true;
        }
        ...
        // không sử dụng
        public bool PurchaseInventoryImporting_UpdateGUI()
        {           
            return true;
        }        

        public bool PurchaseBooking_UpdateGUI()
        {
            return true;
        }

        public bool PurchasePrinting_UpdateGUI()
        {
            return true;
        }
        ...
        protected void cpLine_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            ...
            {
                case "new":                             
                    GUIContext = new Context(new PurchaseLoading(this, true));
                ...
                case "edit":
                    GUIContext.State = new PurchaseEditing(this, true);
                    GUIContext.Request("UpdateGUI");     
                    
                    break;

                case "save":
                    GUIContext.State = new PurchaseCreating(this, true);
                    GUIContext.Request("UpdateGUI");

                    break;

                case "inventoryexport":
                    GUIContext.State = new PurchaseInventoryImporting(this, true);
                    GUIContext.Request("UpdateGUI");
                ...
                case "txtProductTax_ValueChanged":
                    ...
                    txtAmount.Value = (txtProductTotal.Value == null ? 0 : double.Parse(txtProductTotal.Value.ToString())) + (txtServiceTotal.Value == null ? 0 : double.Parse(txtServiceTotal.Value.ToString()));
                ...
                case "txtProductDiscountAmount_ValueChanged":
                    ...
                    //cpLine.JSProperties.Add("cpSaving", "true");
                ...
                case "txtProductDiscountSum_ValueChanged":
                    ...
                    txtAmount.Value = (txtProductTotal.Value == null ? 0 : double.Parse(txtProductTotal.Value.ToString())) + (txtProductTotal.Value == null ? 0 : double.Parse(txtServiceTotal.Value.ToString()));
                ...
                //case "cboUser_ValueChanged":
                //    cpLine.JSProperties.Add("cpUser", "valid");
                //    break;
                //case "cboSupplier_ValueChanged":
                //    cpLine.JSProperties.Add("cpSupplier", "valid");
                //    break;
                ...
                case "itemproperty":
                    ...
                    //Session["ItemUnitId"] = Guid.Parse(p[1]);                   
            ...
            //    {
            //        uEdittingInputInventoryCommand1.SettingInit(Guid.Parse(Session["SaleBillId"].ToString()), bOutputInventoryCommand);
            //    }
            //}
        }
        ...
        protected void grdPurchaseEditProduct_CellEditorInitialize(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewEditorEventArgs e)
        {
            ...
            if (e.Column.FieldName == "ItemUnitId!Key")
            {
                ...
                if (combo != null)
                {
                    ...
                    combo.ItemsRequestedByFilterCondition += new ListEditItemsRequestedByFilterConditionEventHandler(comboItemUnit_ItemsRequestedByFilterCondition);
                    combo.ItemRequestedByValue += new ListEditItemRequestedByValueEventHandler(comboItemUnit_ItemRequestedByValue);
                }
            }
        }
        ...
        protected void grdPurchaseEditProduct_CustomColumnDisplayText(object sender, ASPxGridViewColumnDisplayTextEventArgs e)
        {
            if (e.Column.FieldName == "ItemUnitId!Key")
            {
                ...
                e.DisplayText = itemUnit.ItemId.Code;
            }
        }

        protected void grdPurchaseEditProduct_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            PurchaseInvoice bill = session.GetObjectByKey<PurchaseInvoice>(Guid.Parse(Session["SaleBillId"].ToString()));
            //if (bill != null)
            //{
            ...
            {
                bill = new PurchaseInvoice(session);
        ...
        {
            if ((Status == "edit" || Status == "new") && grdDeliveryBillItem.FocusedRowIndex > -1)
            {
                e.Visible = true;
            }
            else
        ...
        {
            PurchaseInvoice salesInvoice = session.GetObjectByKey<PurchaseInvoice>(Guid.Parse(Session["SaleBillId"].ToString()));
            if (salesInvoice != null)
            {
        ...
        protected void colPersonOnItemsRequestedByFilterCondition(object source, ListEditItemsRequestedByFilterConditionEventArgs e)
        {
            ...
            //CriteriaOperator criteria = CriteriaOperator.And(
            //        CriteriaOperator.Or(
            //            new BinaryOperator("Code", String.Format("%{0}%", e.Filter), BinaryOperatorType.Equal),
        ...
        protected void cboSupplierColumn_OnItemsRequestedByFilterCondition_SQL(object source, ListEditItemsRequestedByFilterConditionEventArgs e)
        {
            ...
            TradingCategory supplierTradingCategory = NAS.DAL.Util.getXPCollection<TradingCategory>(session, "Code", "SUPPLIER").FirstOrDefault();
