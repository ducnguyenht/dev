<%@ Control Language="C#" ClientIDMode="AutoID" AutoEventWireup="true" CodeBehind="BookingEntriesForm.ascx.cs" Inherits="WebModule.Invoice.SalesInvoice.Control.BookingEntriesForm.BookingEntriesForm" %>
...
<script type="text/javascript">
    ...
    function panelBookingEntriesPopup_EndCallback(s, e)
    {
        ...
        {
            console.log('panelBookingEntriesPopup closing');
                ...
                <ContentCollection>
                    <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server" SupportsDisabledAttribute="True">
                        <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%">
                            <Items>
                                <dx:LayoutGroup Caption="Thông tin phiếu bán hàng" ColCount="3">
                                    <Items>
                                        <dx:LayoutItem Caption="Số phiếu bán">
                                ...
                                <dx:LayoutGroup Caption="Thông tin hạch toán">
                                    <Items>
                                        <dx:LayoutGroup Caption="Bút toán phiếu bán hàng">
                                            <Items>
                                        ...
                                        <dx:LayoutGroup Caption="Bút toán phiếu thu liên quan">
                                            <Items>
                                                <dx:LayoutItem Caption=" " ShowCaption="False">
                                                    <LayoutItemNestedControlCollection>
                                        ...
                                        <dx:LayoutGroup Caption="Bút toán phiếu xuất kho liên quan">
                                            <Items>
                                                <dx:LayoutItem Caption=" " ShowCaption="False">
                                                    <LayoutItemNestedControlCollection>
