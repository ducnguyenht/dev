...
namespace WebModule.Invoice.PurchaseInvoice.Control.DeliverySchedule
{
    public partial class ucDeliverySchedule : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (url.Contains("Invoice/PurchaseInvoice/GUI/FixedAssetsPurchaseInvoiceListingForm.aspx"))
            {
                GridDeliveryActual.Columns[2].Caption = "Tài sản cố định";
            }
            else if (url.Contains("Invoice/PurchaseInvoice/GUI/MaterialPurchaseInvoiceListingForm.aspx"))
            {
                GridDeliveryActual.Columns[2].Caption = "Nguyên vật liệu";
            }
            else if (url.Contains("Invoice/PurchaseInvoice/GUI/ToolPurchaseInvoiceListingForm.aspx"))
            {
                GridDeliveryActual.Columns[2].Caption = "Công cụ, dụng cụ";
            }
        }
        ...
        public void DataBind()
        {
            if (BillId != null)
            {
                ...
                GridDeliveryActual.DataSource = inventoryCommandBO.GetActualInventoryJournalOfBill(session, BillId, NAS.DAL.CMS.ObjectDocument.DefaultObjectTypeCustomFieldEnum.INVENTORY_IN_PURCHASE_INVOICE);
