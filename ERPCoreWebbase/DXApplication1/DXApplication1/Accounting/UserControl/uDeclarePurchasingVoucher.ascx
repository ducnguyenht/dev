<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uDeclarePurchasingVoucher.ascx.cs" Inherits="WebModule.Accounting.UserControl.uDeclarePurchasingVoucher" %>
        ...
        <dx:LayoutItem Caption="Chi tiết hóa đơn" ShowCaption="false" ColSpan="3">
            <LayoutItemNestedControlCollection>
                <dx:LayoutItemNestedControlContainer runat="server" 
                    ...
                    <dx:ASPxPageControl ID="pc_purchasingdetail" ClientInstanceName="pc_purchasingdetail" runat="server" ActiveTabIndex="0"
