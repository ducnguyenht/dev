<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="WarehouseVoucher.aspx.cs" Inherits="WebModule.Warehouse.Report.WarehouseVoucher" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainHolder" runat="server">
    ...
    <dx:ASPxLabel ID="lblHeader" runat="server" Text="Danh sách chứng từ kế toán kho"
