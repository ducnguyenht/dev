...
{
    public class PricePolicyExceptionMenuEditting : NAS.GUI.Pattern.State
    {
        public PricePolicyExceptionMenuEditting(System.Web.UI.Control _UIControl)
            : base(_UIControl) { }
        ...
        public override bool UpdateGUI()
        {
            ...
            usrc.UpdateGUI_ExceptionMenuUpdatingEditting();
            return true;
        }
